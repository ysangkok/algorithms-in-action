...
public class MinSpanTreePrimGraphMapsAnimationWindowExt extends AnimationWindow
{
    ...
    public MinSpanTreePrimGraphMapsAnimationWindowExt(final AlgorithmCanvas canvas, final AlgorithmThread thread, final Applet applet) {
        ...
        this.HIDE_MATRIX_LABEL = Messages.getString("MinSpanTreePrimGraphMapsAnimationWindowExt.1");
        this.SHOW_MATRIX_LABEL = Messages.getString("MinSpanTreePrimGraphMapsAnimationWindowExt.2");
        this.HIDE_STRUCTURE_LABEL = Messages.getString("MinSpanTreePrimGraphMapsAnimationWindowExt.3");
        this.SHOW_STRUCTURE_LABEL = Messages.getString("MinSpanTreePrimGraphMapsAnimationWindowExt.4");
        this.frameTitle = MinSpanTreePrimGraphMapsAnimationWindowExt.FRAME_TITLE;
    ...
    static {
        FRAME_TITLE = Messages.getString("MinSpanTreePrimGraphMapsAnimationWindowExt.0");
    }
}
