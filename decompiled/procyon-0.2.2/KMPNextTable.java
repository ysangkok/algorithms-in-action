...
public class KMPNextTable implements Drawable
{
    protected int size;
    protected int[] data;
    ...
    public KMPNextTable(final int size) {
        super();
        this.location = new Point();
        this.infoStart = Messages.getString("KMPNextTable.0");
        this.infoEnd = "] =";
        this.noInfo = true;
        this.labelColor = Color.red;
        this.defaultHighlightColor = new Color(255, 90, 90);
        this.highlightColor = new Color(255, 90, 90);
    ...
    public void draw(final Graphics g) {
        ...
        for (int i = 0; i < this.size; ++i) {
            if (this.highlightIndex && i == this.labelIndex) {
    ...
    public Point getNodePosition(final int index) {
        final Point temp = new Point();
        temp.x = this.location.x + this.stringWidth + this.XGap;
        temp.y = this.location.y + (this.trueHeight + this.YGap) * index;
        return temp;
    }
    ...
    private void initialise() {
        ...
        for (int i = 0; i < this.size; ++i) {
            ...
            this.dataNode[i].setHighlightColor(this.highlightColor);
        }
        this.noInfo = true;
    ...
    public void reInit() {
        this.stringHeight = KMPApplet.theKMPCanvas.getGraphics().getFontMetrics().getHeight();
        this.stringWidth = KMPApplet.theKMPCanvas.getGraphics().getFontMetrics().stringWidth(this.infoStart + "" + this.size + this.infoEnd);
    ...
    public void restoreHighlightColor(final Color c) {
    ...
    public void set(final int index, final int theData) {
        ...
        this.dataNode[index].setHighlightColor(this.highlightColor);
    }
    ...
    public void setLabelIndex(final int s) {
        this.labelIndex = s;
    }
