...
public class SplayTreeIterDataItem extends Element
{
    ...
    public SplayTreeIterDataItem(final String label, final int key) {
        super(2, label);
    ...
    public boolean equals(final Selectable selectable) {
        return selectable instanceof SplayTreeIterDataItem && this.label.compareTo(((SplayTreeIterDataItem)selectable).label) == 0;
    }
