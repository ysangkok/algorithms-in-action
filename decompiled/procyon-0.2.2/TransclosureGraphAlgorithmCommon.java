...
public class TransclosureGraphAlgorithmCommon
{
    ...
    TransclosureGraphAlgorithmCommon(final GraphMaps p_algorithm, final Object p_data) {
        super();
    ...
    public void startEditLink(final Integer p_link_weight) {
        ...
        this.m_startNode = -10;
        this.m_endNode = -10;
        if (TransclosureGraphAlgorithmCommon.messageDialog != null) {
            TransclosureGraphAlgorithmCommon.messageDialog.dispose();
        }
        TransclosureGraphAlgorithmCommon.messageDialog = new MessageDialog(Messages.getString("TransclosureGraphAlgorithmCommon.3"), false, false);
        TransclosureGraphAlgorithmCommon.messageDialog.setTitle(Messages.getString("TransclosureGraphAlgorithmCommon.4"));
        TransclosureGraphAlgorithmCommon.messageDialog.setVisible(true);
    ...
    public void setStartNode(final int p_key) {
        ...
        TransclosureGraphAlgorithmCommon.messageDialog = new MessageDialog(Messages.getString("TransclosureGraphAlgorithmCommon.5"), false, false);
        TransclosureGraphAlgorithmCommon.messageDialog.setTitle(Messages.getString("TransclosureGraphAlgorithmCommon.6"));
        TransclosureGraphAlgorithmCommon.messageDialog.setVisible(true);
    ...
    public void setKeyChangeMode(final boolean p_keyChange) {
        ...
        if (this.m_bKeyChangeMode) {
            TransclosureGraphAlgorithmCommon.messageDialog = new MessageDialog(Messages.getString("TransclosureGraphAlgorithmCommon.7"), false, false);
            TransclosureGraphAlgorithmCommon.messageDialog.setTitle(Messages.getString("TransclosureGraphAlgorithmCommon.8"));
            TransclosureGraphAlgorithmCommon.messageDialog.setVisible(true);
        }
    }
    ...
    public void setInsertionMode(final boolean p_insertion) {
        ...
        if (this.m_bInsertionMode) {
            TransclosureGraphAlgorithmCommon.messageDialog = new MessageDialog(Messages.getString("TransclosureGraphAlgorithmCommon.9"), false, false);
            TransclosureGraphAlgorithmCommon.messageDialog.setTitle(Messages.getString("TransclosureGraphAlgorithmCommon.10"));
            TransclosureGraphAlgorithmCommon.messageDialog.setVisible(true);
        }
    }
    ...
    public void setDeleteMode(final boolean p_deleteMode) {
        ...
        if (this.m_bDeleteMode) {
            TransclosureGraphAlgorithmCommon.messageDialog = new MessageDialog(Messages.getString("TransclosureGraphAlgorithmCommon.11"), false, false);
            TransclosureGraphAlgorithmCommon.messageDialog.setTitle(Messages.getString("TransclosureGraphAlgorithmCommon.12"));
            TransclosureGraphAlgorithmCommon.messageDialog.setVisible(true);
        }
    }
    ...
    public void deleteNode(final int p_node) {
        ...
        final Vector<E> tempData = new Vector();
    ...
    public Vector<E> getNodes() {
        ...
        final Vector<E> nodeArray = new Vector();
    ...
    public Vector<E> getAdjacencyMatrix() {
        final Vector<E> vecAdjacencyMatrix = new Vector();
