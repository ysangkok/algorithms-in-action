...
public class DFSGraphAlgorithmCommon
{
    ...
    DFSGraphAlgorithmCommon(final GraphMaps p_algorithm, final Object p_data) {
        super();
    ...
    public void startEditLink(final Integer p_link_weight) {
        ...
        this.m_startNode = -10;
        this.m_endNode = -10;
        if (DFSGraphAlgorithmCommon.messageDialog != null) {
            DFSGraphAlgorithmCommon.messageDialog.dispose();
        }
        DFSGraphAlgorithmCommon.messageDialog = new MessageDialog(Messages.getString("DFSGraphAlgorithmCommon.3"), false, false);
        DFSGraphAlgorithmCommon.messageDialog.setTitle(Messages.getString("DFSGraphAlgorithmCommon.4"));
        DFSGraphAlgorithmCommon.messageDialog.setVisible(true);
    ...
    public void setStartNode(final int p_key) {
        ...
        DFSGraphAlgorithmCommon.messageDialog = new MessageDialog(Messages.getString("DFSGraphAlgorithmCommon.5"), false, false);
        DFSGraphAlgorithmCommon.messageDialog.setTitle(Messages.getString("DFSGraphAlgorithmCommon.6"));
        DFSGraphAlgorithmCommon.messageDialog.setVisible(true);
    ...
    public void endEditLink() {
        ...
        DFSGraphAlgorithmCommon.messageDialog = null;
        this.m_algorithm.repaint();
    }
    ...
    public void setKeyChangeMode(final boolean p_keyChange) {
        ...
        if (this.m_bKeyChangeMode) {
            DFSGraphAlgorithmCommon.messageDialog = new MessageDialog(Messages.getString("DFSGraphAlgorithmCommon.7"), false, false);
            DFSGraphAlgorithmCommon.messageDialog.setTitle(Messages.getString("DFSGraphAlgorithmCommon.8"));
            DFSGraphAlgorithmCommon.messageDialog.setVisible(true);
        }
    }
    ...
    public void setInsertionMode(final boolean p_insertion) {
        ...
        if (this.m_bInsertionMode) {
            DFSGraphAlgorithmCommon.messageDialog = new MessageDialog(Messages.getString("DFSGraphAlgorithmCommon.9"), false, false);
            DFSGraphAlgorithmCommon.messageDialog.setTitle(Messages.getString("DFSGraphAlgorithmCommon.10"));
            DFSGraphAlgorithmCommon.messageDialog.setVisible(true);
        }
    }
    ...
    public void setDeleteMode(final boolean p_deleteMode) {
        ...
        if (this.m_bDeleteMode) {
            DFSGraphAlgorithmCommon.messageDialog = new MessageDialog(Messages.getString("DFSGraphAlgorithmCommon.11"), false, false);
            DFSGraphAlgorithmCommon.messageDialog.setTitle(Messages.getString("DFSGraphAlgorithmCommon.12"));
            DFSGraphAlgorithmCommon.messageDialog.setVisible(true);
        }
    }
