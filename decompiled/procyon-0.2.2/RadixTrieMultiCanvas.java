...
public class RadixTrieMultiCanvas extends AlgorithmCanvas
{
    ...
    public void displayAlgorithm(final Graphics g) {
        try {
            ...
            if (this.levelNode != null) {
                ...
                this.levelNode.setPosition(new Point(g.getFontMetrics().stringWidth(Messages.getString("RadixTrieMultiCanvas.1")) + 20, windowBottom - 15));
            ...
            if (this.currentNode != null && !(this.head instanceof RadixTrieMultiNullNode)) {
                ...
                this.drawLine(g, start, end, "Current Trie");
            }
    ...
    public void processRepaintEvent(final RepaintEvent e) {
        if (e.paramObj != null) {
            ...
            final RadixTrieMulti radixTrieAlgorithm = (RadixTrieMulti)((RadixTrieMulti)e.paramObj);
            this.mostSignificantBit = radixTrieAlgorithm.getMostSignificantBit();
            this.currentLevel = radixTrieAlgorithm.getCurrentLevel();
            if (this.currentLevel >= 0) {
                this.levelNode = new Node(new Integer(this.currentLevel / RadixTrieMulti.NO_OF_BITS), 0);
            }
            else {
                this.levelNode = null;
            }
            ...
            if (this.insertBitArray != null) {
                this.insertBitArray.setLabel(Messages.getString("RadixTrieMultiCanvas.4"));
            ...
            if (this.compareBitArray != null) {
                this.compareBitArray.setLabel(Messages.getString("RadixTrieMultiCanvas.5"));
            ...
            if (this.searchBitArray != null) {
                this.searchBitArray.setLabel(Messages.getString("RadixTrieMultiCanvas.6"));
            ...
            if (this.finalCompareBitArray != null) {
                this.finalCompareBitArray.setLabel(Messages.getString("RadixTrieMultiCanvas.7"));
    ...
    private void drawInsertedData(final Graphics g, final RadixTrieMultiNode node, final Point pos) {
        if (this.insertedData != null) {
            for (int i = 0; i < this.insertedData.size(); ++i) {
                final RadixTrieMultiExternalNode radixNode = (RadixTrieMultiExternalNode)this.insertedData.elementAt(i);
