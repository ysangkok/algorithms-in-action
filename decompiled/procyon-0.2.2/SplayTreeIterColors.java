...
public class SplayTreeIterColors
{
    ...
    static {
        ...
        INSERT_HIGHLIGHT_COLOR = Color.yellow;
        ...
        NEW_NODE_COLOR = SplayTreeIterColors.INSERT_HIGHLIGHT_COLOR;
        FOUND_NODE_COLOR = SplayTreeIterColors.SEARCH_HIGHLIGHT_COLOR;
