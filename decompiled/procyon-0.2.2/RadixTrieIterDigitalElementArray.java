...
public class RadixTrieIterDigitalElementArray implements Drawable, Selectable
{
    ...
    public RadixTrieIterDigitalElementArray(final int data, final int numberOfBits, final boolean isShow) {
        this(data, numberOfBits);
        this.isShowDigits = isShow;
    }
    
    public RadixTrieIterDigitalElementArray(final int data, final int numberOfBits) {
        super();
    ...
    public void draw(final Graphics g) {
        ...
        if (this.label != null) {
            g.setColor(RadixTrieIterDigitalElementArray.DEFAULT_TEXT_COLOR);
    ...
    public void unHighlight() {
        for (int i = 0; i < this.bitElementArray.getSize(); ++i) {
            ...
            if (this.bitNumbers != null) {
                this.bitNumbers[i].setBackgroundColor(RadixTrieIterDigitalElementArray.DEFAULT_BACKGROUND_COLOR);
            }
        }
    }
    ...
    static {
        BIT_ARRAY_LABEL = Messages.getString("RadixTrieIterDigitalElementArray.0");
