...
public class MyElementArrayQS implements Drawable, Selectable, ObjectContainer
{
    ...
    public MyElementArrayQS(final int xBuffer, final int yAxis) {
        super();
        this.columGap = 10;
    ...
    public boolean equals(final Selectable selectable) {
        if (!(selectable instanceof MyElementArrayQS)) {
            return false;
        }
        final MyElementArrayQS elementArray = (MyElementArrayQS)selectable;
