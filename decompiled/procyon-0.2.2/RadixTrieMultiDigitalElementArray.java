...
public class RadixTrieMultiDigitalElementArray implements Drawable, Selectable
{
    ...
    public RadixTrieMultiDigitalElementArray(final int data, final int numberOfBits, final boolean isShow) {
        this(data, numberOfBits);
        this.isShowDigits = isShow;
    }
    
    public RadixTrieMultiDigitalElementArray(final int data, final int numberOfBits) {
        super();
    ...
    public void draw(final Graphics g) {
        ...
        if (this.label != null) {
            g.setColor(RadixTrieMultiDigitalElementArray.DEFAULT_TEXT_COLOR);
    ...
    public void addMarker(final StringMarker marker) {
        this.dataNode.addMarker(marker);
    }
    
    public void removeAllMarkers() {
        this.dataNode.removeAllMarkers();
    }
    ...
    public void unHighlight() {
        for (int i = 0; i < this.bitElementArray.getSize(); ++i) {
            ...
            if (this.bitNumbers != null) {
                this.bitNumbers[i].setBackgroundColor(RadixTrieMultiDigitalElementArray.DEFAULT_BACKGROUND_COLOR);
            }
        }
    }
    ...
    static {
        BIT_ARRAY_LABEL = Messages.getString("RadixTrieMultiDigitalElementArray.0");
