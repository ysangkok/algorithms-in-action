...
public class SplayTreeDataItem extends Element
{
    ...
    public SplayTreeDataItem(final String label, final int key) {
        super(2, label);
    ...
    public boolean equals(final Selectable selectable) {
        return selectable instanceof SplayTreeDataItem && this.label.compareTo(((SplayTreeDataItem)selectable).label) == 0;
    }
