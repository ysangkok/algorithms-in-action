...
public class TransclosureGraphCanvasCommonExt extends GraphMapsCanvasExt
{
    ...
    TransclosureGraphCanvasCommonExt(final GraphMapsCanvasExt p_canvas, final GraphMaps p_algorithm) {
        super();
    ...
    public void processDialogEvent(final String sourceDialog, final String value) {
        if (this.m_algorithm != null && !this.m_algorithm.getIsRunning() && value != null && sourceDialog.equals(Messages.getString("TransclosureGraphCanvasCommonExt.0"))) {
    ...
    public void editMatrix(final GraphMapsNode p_Node) {
        if (this.m_algorithm != null && !this.m_algorithm.getIsRunning()) {
            ...
            this.m_dlgMatrixEdit = new InputDialog(this.m_canvas, this.m_frmMatrixEdit, Messages.getString("TransclosureGraphCanvasCommonExt.1"), true, Messages.getString("TransclosureGraphCanvasCommonExt.2"), p_Node.getIntValue());
    ...
    public void drawAdjacencyMatrix(final Graphics g) {
        ...
        g.drawString(Messages.getString("TransclosureGraphCanvasCommonExt.3"), this.MATRIX_X, this.MATRIX_Y - fm.getHeight());
        final String string = Messages.getString("TransclosureGraphCanvasCommonExt.4");
        final int n = this.MATRIX_X - fm.stringWidth(Messages.getString("TransclosureGraphCanvasCommonExt.5"));
        final int matrix_Y = this.MATRIX_Y;
        final GraphMapsCanvasExt canvas = this.m_canvas;
        g.drawString(string, n, matrix_Y + 20 - fm.getMaxDescent());
        g.drawString(Messages.getString("TransclosureGraphCanvasCommonExt.6"), this.MATRIX_X, this.MATRIX_Y - fm.getHeight() * 2);
    ...
    public void drawAdjacencyStructure(final Graphics g) {
        ...
        g.setColor(Color.blue);
        final FontMetrics fm = g.getFontMetrics();
        g.drawString(Messages.getString("TransclosureGraphCanvasCommonExt.7"), this.earrAdjacencyStructure.getLocation().x, this.STRUCTURE_Y - fm.getHeight() * 2);
        g.setColor(this.m_canvas.getTextColor());
