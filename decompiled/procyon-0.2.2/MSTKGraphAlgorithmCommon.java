...
public class MSTKGraphAlgorithmCommon extends GraphAlgorithmCommon
{
    ...
    MSTKGraphAlgorithmCommon(final MSTKGraphMaps p_algorithm, final Object p_data) {
        super();
    ...
    public void startEditLink(final Integer p_link_weight) {
        ...
        this.m_startNode = -10;
        this.m_endNode = -10;
        if (MSTKGraphAlgorithmCommon.messageDialog != null) {
            MSTKGraphAlgorithmCommon.messageDialog.dispose();
        }
        MSTKGraphAlgorithmCommon.messageDialog = new MessageDialog(Messages.getString("MSTKGraphAlgorithmCommon.3"), false, false);
        MSTKGraphAlgorithmCommon.messageDialog.setTitle(Messages.getString("MSTKGraphAlgorithmCommon.4"));
        MSTKGraphAlgorithmCommon.messageDialog.setVisible(true);
    ...
    public void setStartNode(final int p_key) {
        ...
        MSTKGraphAlgorithmCommon.messageDialog = new MessageDialog(Messages.getString("MSTKGraphAlgorithmCommon.5"), false, false);
        MSTKGraphAlgorithmCommon.messageDialog.setTitle(Messages.getString("MSTKGraphAlgorithmCommon.6"));
        MSTKGraphAlgorithmCommon.messageDialog.setVisible(true);
    ...
    public void setKeyChangeMode(final boolean p_keyChange) {
        ...
        if (this.m_bKeyChangeMode) {
            MSTKGraphAlgorithmCommon.messageDialog = new MessageDialog(Messages.getString("MSTKGraphAlgorithmCommon.7"), false, false);
            MSTKGraphAlgorithmCommon.messageDialog.setTitle(Messages.getString("MSTKGraphAlgorithmCommon.8"));
            MSTKGraphAlgorithmCommon.messageDialog.setVisible(true);
        }
    }
    ...
    public void setInsertionMode(final boolean p_insertion) {
        ...
        if (this.m_bInsertionMode) {
            MSTKGraphAlgorithmCommon.messageDialog = new MessageDialog(Messages.getString("MSTKGraphAlgorithmCommon.9"), false, false);
            MSTKGraphAlgorithmCommon.messageDialog.setTitle(Messages.getString("MSTKGraphAlgorithmCommon.10"));
            MSTKGraphAlgorithmCommon.messageDialog.setVisible(true);
        }
    }
    ...
    public void setDeleteMode(final boolean p_deleteMode) {
        ...
        if (this.m_bDeleteMode) {
            MSTKGraphAlgorithmCommon.messageDialog = new MessageDialog(Messages.getString("MSTKGraphAlgorithmCommon.11"), false, false);
            MSTKGraphAlgorithmCommon.messageDialog.setTitle(Messages.getString("MSTKGraphAlgorithmCommon.12"));
            MSTKGraphAlgorithmCommon.messageDialog.setVisible(true);
        }
    }
