...
public class TransclosureGraphCanvasCommon extends GraphCanvasCommon
{
    ...
    TransclosureGraphCanvasCommon(final GraphMapsCanvas p_canvas, final GraphMaps p_algorithm) {
        super();
        this.GRAPH_X = 30;
        this.GRAPH_Y = 30;
        this.vecNodes = null;
    ...
    public void processDialogEvent(final String sourceDialog, final String value) {
        if (this.m_algorithm != null && !this.m_algorithm.getIsRunning() && value != null) {
            ...
            else if (sourceDialog.equals(Messages.getString("TransclosureGraphCanvasCommon.1"))) {
            ...
            for (int i = 0; i < this.vecNodes.size(); ++i) {
                ...
                if (px > node.getX() && px < node.getX() + node.getWidth() && py > node.getY() && py < node.getY() + node.getHeight()) {
                    if (this.m_algorithm.getKeyChangeMode()) {
                        ...
                        this.m_dlgKeyChange = new InputDialog(this.m_canvas, this.m_frmKeyChange, Messages.getString("TransclosureGraphCanvasCommon.2"), true, Messages.getString("TransclosureGraphCanvasCommon.3"), node.getIntValue());
                        ...
                        switch (this.m_algorithm.getEditLinkStep()) {
                            ...
                            case 2: {
                                ...
                                if (this.m_algorithm.needPromptForLinkWeight()) {
                                    ...
                                    this.m_dlgEditLink = new InputDialog(this.m_canvas, this.m_frmEditLink, Messages.getString("TransclosureGraphCanvasCommon.4"), true, Messages.getString("TransclosureGraphCanvasCommon.5"), this.m_algorithm.getCurrentLinkLinkWeight());
