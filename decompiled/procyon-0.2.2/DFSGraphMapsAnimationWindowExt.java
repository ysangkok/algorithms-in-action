...
public class DFSGraphMapsAnimationWindowExt extends AnimationWindow
{
    ...
    public DFSGraphMapsAnimationWindowExt(final AlgorithmCanvas canvas, final AlgorithmThread thread, final Applet applet) {
        ...
        this.SHOW_MATRIX_LABEL = Messages.getString("DFSGraphMapsAnimationWindowExt.1");
        this.HIDE_MATRIX_LABEL = Messages.getString("DFSGraphMapsAnimationWindowExt.2");
        this.SHOW_STRUCTURE_LABEL = Messages.getString("DFSGraphMapsAnimationWindowExt.3");
        this.HIDE_STRUCTURE_LABEL = Messages.getString("DFSGraphMapsAnimationWindowExt.4");
        this.frameTitle = DFSGraphMapsAnimationWindowExt.FRAME_TITLE;
    ...
    static {
        FRAME_TITLE = Messages.getString("DFSGraphMapsAnimationWindowExt.0");
    }
}
