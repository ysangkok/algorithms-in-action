...
public class MergeBUSortAnimationWindow extends AnimationWindow
{
    ...
    public MergeBUSortAnimationWindow(final AlgorithmCanvas canvas, final AlgorithmThread thread, final Applet applet) {
        ...
        this.frameTitle = MergeBUSortAnimationWindow.FRAME_TITLE;
        this.addDataSelection(new PresetIntArrayDataSelection(MergeBUSortAnimationWindow.DEFAULT_LABEL, true, this, MergeBUSortAnimationWindow.DEFAULT_DATA));
        this.addDataSelection(new PresetIntArrayDataSelection(MergeBUSortAnimationWindow.SORTED_LABEL, false, this, MergeBUSortAnimationWindow.SORTED_DATA));
        this.addDataSelection(new PresetIntArrayDataSelection(MergeBUSortAnimationWindow.REVERSE_SORTED_LABEL, false, this, MergeBUSortAnimationWindow.REVERSE_SORTED_DATA));
        this.addDataSelection(new RandomSameIntArrayDataSelection(MergeBUSortAnimationWindow.SAME_LABEL, false, this, this.minimumNumberOfElements, this.maximumNumberOfElements, this.minSize, this.maxSize));
        this.addDataSelection(new RandomIntArrayDataSelection(MergeBUSortAnimationWindow.RANDOM_LABEL, false, this, this.minimumNumberOfElements, this.maximumNumberOfElements, this.minSize, this.maxSize));
        this.addDataSelection(new UserSelectionIntArrayDataSelection(MergeBUSortAnimationWindow.USER_SELECTION_LABEL + "...", false, this, MergeBUSortAnimationWindow.USER_SELECTION_LABEL, this.minSize, this.maxSize, this.minimumNumberOfElements, this.maximumNumberOfElements));
    ...
    public void resetThread() {
        ((MergeBUSortThread)this.thread).resetSeed();
        super.resetThread();
    }
    
    static {
        FRAME_TITLE = Messages.getString("MergeBUSortAnimationWindow.2");
