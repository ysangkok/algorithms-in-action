...
public class DFSGraphCanvasCommonExt
{
    ...
    DFSGraphCanvasCommonExt(final DFSGraphMapsCanvasExt p_canvas, final DFSGraphMaps p_algorithm) {
        super();
    ...
    public void setMatrix(final Vector<E> p_matrix, final int matrix_x, final int matrix_y) {
        ...
        if (this.vecAdjacencyMatrix != null) {
            ...
            final DFSGraphMapsCanvasExt canvas = this.m_canvas;
    ...
    private void calculateStructureHeight() {
        ...
        for (int i = 0; i < this.m_algorithm.getNumberOfNodes(); ++i) {
            ...
            while (root != null) {
                ...
                final DFSGraphMapsCanvasExt canvas2 = this.m_canvas;
    ...
    public void processDialogEvent(final String sourceDialog, final String value) {
        if (this.m_algorithm != null && !this.m_algorithm.getIsRunning() && value != null && sourceDialog.equals(Messages.getString("DFSGraphCanvasCommonExt.0"))) {
    ...
    public void editMatrix(final GraphMapsNode p_Node) {
        if (this.m_algorithm != null && !this.m_algorithm.getIsRunning()) {
            ...
            this.m_dlgMatrixEdit = new InputDialog(this.m_canvas, this.m_frmMatrixEdit, Messages.getString("DFSGraphCanvasCommonExt.1"), true, Messages.getString("DFSGraphCanvasCommonExt.2"), p_Node.getIntValue());
    ...
    public void drawAdjacencyMatrix(final Graphics g) {
        ...
        g.drawString(Messages.getString("DFSGraphCanvasCommonExt.3"), this.MATRIX_X, this.MATRIX_Y - fm.getHeight());
        final String string = Messages.getString("DFSGraphCanvasCommonExt.4");
        final int n = this.MATRIX_X - fm.stringWidth(Messages.getString("DFSGraphCanvasCommonExt.5"));
        final int matrix_Y = this.MATRIX_Y;
        final DFSGraphMapsCanvasExt canvas = this.m_canvas;
        g.drawString(string, n, matrix_Y + 20 - fm.getMaxDescent());
        g.drawString(Messages.getString("DFSGraphCanvasCommonExt.6"), this.MATRIX_X, this.MATRIX_Y - fm.getHeight() * 2);
        ...
        for (int i = 0; i < this.vecAdjacencyMatrix.size(); ++i) {
            ...
            final DFSGraphMapsCanvasExt canvas3 = this.m_canvas;
            ...
            final DFSGraphMapsCanvasExt canvas4 = this.m_canvas;
    ...
    public void drawAdjacencyStructure(final Graphics g) {
        ...
        g.setColor(Color.blue);
        final FontMetrics fm = g.getFontMetrics();
        g.drawString(Messages.getString("DFSGraphCanvasCommonExt.7"), this.earrAdjacencyStructure.getLocation().x, this.STRUCTURE_Y - fm.getHeight() * 2);
        g.setColor(this.m_canvas.getTextColor());
        ...
        for (int i = 0; i < this.m_algorithm.getNumberOfNodes(); ++i) {
            ...
            while (root != null) {
                ...
                final DFSGraphMapsCanvasExt canvas5 = this.m_canvas;
                ...
                final DFSGraphMapsCanvasExt canvas6 = this.m_canvas;
