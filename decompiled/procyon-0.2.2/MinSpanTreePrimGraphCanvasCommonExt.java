...
public class MinSpanTreePrimGraphCanvasCommonExt extends GraphCanvasCommonExt
{
    ...
    MinSpanTreePrimGraphCanvasCommonExt(final GraphMapsCanvasExt p_canvas, final GraphMaps p_algorithm) {
        super();
    ...
    public void setMatrix(final Vector<E> p_matrix, final int matrix_x, final int matrix_y) {
        ...
        if (this.vecAdjacencyMatrix != null) {
            ...
            final GraphMapsCanvasExt canvas = this.m_canvas;
    ...
    private void calculateStructureHeight() {
        ...
        for (int i = 0; i < this.m_algorithm.getNumberOfNodes(); ++i) {
            ...
            while (root != null) {
                ...
                final GraphMapsCanvasExt canvas2 = this.m_canvas;
    ...
    public void processDialogEvent(final String sourceDialog, final String value) {
        if (this.m_algorithm != null && !this.m_algorithm.getIsRunning() && value != null && sourceDialog.equals(Messages.getString("MinSpanTreePrimGraphCanvasCommonExt.0"))) {
    ...
    public void editMatrix(final GraphMapsNode p_Node) {
        if (this.m_algorithm != null && !this.m_algorithm.getIsRunning()) {
            ...
            this.m_dlgMatrixEdit = new InputDialog(this.m_canvas, this.m_frmMatrixEdit, Messages.getString("MinSpanTreePrimGraphCanvasCommonExt.7"), true, Messages.getString("MinSpanTreePrimGraphCanvasCommonExt.8"), p_Node.getIntValue());
    ...
    public void drawAdjacencyMatrix(final Graphics g) {
        ...
        g.drawString(Messages.getString("MinSpanTreePrimGraphCanvasCommonExt.9"), this.MATRIX_X, this.MATRIX_Y - fm.getHeight());
        final String string = Messages.getString("MinSpanTreePrimGraphCanvasCommonExt.10");
        final int n = this.MATRIX_X - fm.stringWidth(Messages.getString("MinSpanTreePrimGraphCanvasCommonExt.11"));
        final int matrix_Y = this.MATRIX_Y;
        final GraphMapsCanvasExt canvas = this.m_canvas;
        g.drawString(string, n, matrix_Y + 20 - fm.getMaxDescent());
        g.drawString(Messages.getString("MinSpanTreePrimGraphCanvasCommonExt.12"), this.MATRIX_X, this.MATRIX_Y - fm.getHeight() * 2);
        ...
        for (int i = 0; i < this.vecAdjacencyMatrix.size(); ++i) {
            ...
            final GraphMapsCanvasExt canvas3 = this.m_canvas;
            ...
            final GraphMapsCanvasExt canvas4 = this.m_canvas;
    ...
    public void drawAdjacencyStructure(final Graphics g) {
        ...
        g.setColor(Color.blue);
        final FontMetrics fm = g.getFontMetrics();
        g.drawString(Messages.getString("MinSpanTreePrimGraphCanvasCommonExt.13"), this.earrAdjacencyStructure.getLocation().x, this.STRUCTURE_Y - fm.getHeight() * 2);
        g.setColor(this.m_canvas.getTextColor());
        ...
        for (int i = 0; i < this.m_algorithm.getNumberOfNodes(); ++i) {
            ...
            while (root != null) {
                ...
                final GraphMapsCanvasExt canvas5 = this.m_canvas;
                ...
                final GraphMapsCanvasExt canvas6 = this.m_canvas;
