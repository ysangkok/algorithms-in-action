...
public class ElementArray implements Drawable, Selectable, ObjectContainer
{
    ...
    public ElementArray(final int xBuffer, final int yAxis) {
        super();
        this.columGap = 10;
    ...
    public boolean equals(final Selectable selectable) {
        if (!(selectable instanceof ElementArray)) {
            return false;
        }
        final ElementArray elementArray = (ElementArray)selectable;
