...
public class DataItem extends Element
{
    private int key;
    ...
    public DataItem(final String label, final int key) {
        super(2, label);
    ...
    public boolean equals(final Selectable selectable) {
        return selectable instanceof DataItem && this.label.compareTo(((DataItem)selectable).label) == 0;
    }
