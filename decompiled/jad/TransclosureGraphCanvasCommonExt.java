...
// Source File Name:   TransclosureGraphCanvasCommonExt.java
...
public class TransclosureGraphCanvasCommonExt extends GraphMapsCanvasExt
{
    ...
    TransclosureGraphCanvasCommonExt(GraphMapsCanvasExt p_canvas, GraphMaps p_algorithm)
    {
    ...
    {
        if(m_algorithm != null && !m_algorithm.getIsRunning() && value != null && sourceDialog.equals(Messages.getString("TransclosureGraphCanvasCommonExt.0")))
    ...
    public void editMatrix(GraphMapsNode p_Node)
    {
        if(m_algorithm != null && !m_algorithm.getIsRunning())
        {
            ...
            m_dlgMatrixEdit = new InputDialog(m_canvas, m_frmMatrixEdit, Messages.getString("TransclosureGraphCanvasCommonExt.1"), true, Messages.getString("TransclosureGraphCanvasCommonExt.2"), p_Node.getIntValue());
    ...
    public void drawAdjacencyMatrix(Graphics g)
    {
        ...
        g.drawString(Messages.getString("TransclosureGraphCanvasCommonExt.3"), MATRIX_X, MATRIX_Y - fm.getHeight());
        GraphMapsCanvasExt _tmp = m_canvas;
        g.drawString(Messages.getString("TransclosureGraphCanvasCommonExt.4"), MATRIX_X - fm.stringWidth(Messages.getString("TransclosureGraphCanvasCommonExt.5")), (MATRIX_Y + 20) - fm.getMaxDescent());
        g.drawString(Messages.getString("TransclosureGraphCanvasCommonExt.6"), MATRIX_X, MATRIX_Y - fm.getHeight() * 2);
    ...
    public void drawAdjacencyStructure(Graphics g)
    {
        ...
        g.setColor(Color.blue);
        FontMetrics fm = g.getFontMetrics();
        g.drawString(Messages.getString("TransclosureGraphCanvasCommonExt.7"), earrAdjacencyStructure.getLocation().x, STRUCTURE_Y - fm.getHeight() * 2);
        g.setColor(m_canvas.getTextColor());
