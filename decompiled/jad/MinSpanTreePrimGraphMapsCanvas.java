...
// Source File Name:   MinSpanTreePrimGraphMapsCanvas.java
...
public class MinSpanTreePrimGraphMapsCanvas extends GraphMapsCanvas
    implements GraphDialogEventHandler
{
    ...
    public void processRepaintEvent(RepaintEvent e)
    {
        if(e.paramObj != null)
        {
            ...
            graphMaps = (GraphMaps)(GraphMaps)e.paramObj;
            if(commons == null)
                commons = new MinSpanTreePrimGraphCanvasCommon(this, graphMaps);
