...
// Source File Name:   SplayTreeIterAnimationWindow.java
...
public class SplayTreeIterAnimationWindow extends AnimationWindow
    implements ItemListener
{
    ...
    public SplayTreeIterAnimationWindow(AlgorithmCanvas canvas, AlgorithmThread thread, Applet applet)
    {
        ...
        RestartButton restartButton = new RestartButton(Messages.getString("SplayTreeIterAnimationWindow.4"), Messages.getString("SplayTreeIterAnimationWindow.5"), this, thread);
        ...
        Checkbox animateCheckbox = new Checkbox(Messages.getString("SplayTreeIterAnimationWindow.6"), true);
        ...
        addControlListener((ControlListener)((SplayTreeIterThread)thread).getAlgorithm());
    }

    public void itemStateChanged(ItemEvent e)
    {
        if(e.getStateChange() == 1)
            ((SplayTreeIterCanvas)canvas).setIsShowTween(true);
        else
        if(e.getStateChange() == 2)
            ((SplayTreeIterCanvas)canvas).setIsShowTween(false);
    }

    protected static final String BUILD_DATE = "Build Date";
    protected static final String BUILD_BY = "Your Initial.Your Surname";
    protected static final String FRAME_TITLE = Messages.getString("SplayTreeIterAnimationWindow.2");
    ...
    public static final String SORTED_LABAL = Messages.getString("SplayTreeIterAnimationWindow.3");
