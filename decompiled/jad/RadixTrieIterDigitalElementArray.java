...
// Source File Name:   RadixTrieIterDigitalElementArray.java

import com.cim.AIA.*;
import java.awt.*;
import localization.Messages;

public class RadixTrieIterDigitalElementArray
    implements Drawable, Selectable
{

    public RadixTrieIterDigitalElementArray(int data, int numberOfBits, boolean isShow)
    {
        this(data, numberOfBits);
        isShowDigits = isShow;
    }

    public RadixTrieIterDigitalElementArray(int data, int numberOfBits)
    {
    ...
    private static final String BIT_ARRAY_LABEL = Messages.getString("RadixTrieIterDigitalElementArray.0");
