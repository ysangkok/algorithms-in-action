...
// Source File Name:   TransclosureGraphAlgorithmCommon.java
...
public class TransclosureGraphAlgorithmCommon
{
    ...
    TransclosureGraphAlgorithmCommon(GraphMaps p_algorithm, Object p_data)
    {
    ...
    public void startEditLink(Integer p_link_weight)
    {
        ...
        messageDialog = new MessageDialog(Messages.getString("TransclosureGraphAlgorithmCommon.3"), false, false);
        messageDialog.setTitle(Messages.getString("TransclosureGraphAlgorithmCommon.4"));
    ...
    public void setStartNode(int p_key)
    {
        ...
        if(messageDialog != null)
            messageDialog.dispose();
        messageDialog = new MessageDialog(Messages.getString("TransclosureGraphAlgorithmCommon.5"), false, false);
        messageDialog.setTitle(Messages.getString("TransclosureGraphAlgorithmCommon.6"));
        messageDialog.setVisible(true);
        m_editLinkStep++;
        m_algorithm.repaint();
    }
    ...
    public void setKeyChangeMode(boolean p_keyChange)
    {
        ...
        if(m_bKeyChangeMode)
        {
            messageDialog = new MessageDialog(Messages.getString("TransclosureGraphAlgorithmCommon.7"), false, false);
            messageDialog.setTitle(Messages.getString("TransclosureGraphAlgorithmCommon.8"));
            messageDialog.setVisible(true);
        }
    }
    ...
    public void setInsertionMode(boolean p_insertion)
    {
        ...
        if(m_bInsertionMode)
        {
            messageDialog = new MessageDialog(Messages.getString("TransclosureGraphAlgorithmCommon.9"), false, false);
            messageDialog.setTitle(Messages.getString("TransclosureGraphAlgorithmCommon.10"));
            messageDialog.setVisible(true);
        }
    }
    ...
    public void setDeleteMode(boolean p_deleteMode)
    {
        ...
        if(m_bDeleteMode)
        {
            messageDialog = new MessageDialog(Messages.getString("TransclosureGraphAlgorithmCommon.11"), false, false);
            messageDialog.setTitle(Messages.getString("TransclosureGraphAlgorithmCommon.12"));
            messageDialog.setVisible(true);
        }
    }
