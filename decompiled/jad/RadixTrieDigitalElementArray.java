...
// Source File Name:   RadixTrieDigitalElementArray.java

import com.cim.AIA.*;
import java.awt.*;
import localization.Messages;

public class RadixTrieDigitalElementArray
    implements Drawable, Selectable
{

    public RadixTrieDigitalElementArray(int data, int numberOfBits)
    {
    ...
    private static final String BIT_ARRAY_LABEL = Messages.getString("RadixTrieDigitalElementArray.0");
