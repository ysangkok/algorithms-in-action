...
// Source File Name:   SplayTreeIterDataNode.java
...
public class SplayTreeIterDataNode extends SplayTreeIterNode
{
    ...
    public SplayTreeIterDataNode(SplayTreeIterDataItem dataItem)
    {
        currentBackgroundColor = BACKGROUND_COLOR;
        elementNumber = NO_OF_ELEMENTS++;
        this.dataItem = dataItem;
        newestNode = this;
        position = new Point();
        left = new SplayTreeIterNullNode();
        left.setParent(this);
        leftLink = new Line(position, new Point());
        right = new SplayTreeIterNullNode();
    ...
    {
        SplayTreeIterDataNode copyNode = new SplayTreeIterDataNode(dataItem);
    ...
    public void setLeft(SplayTreeIterNode left)
    {
        this.left = left;
        left.setParent(this);
    }
    ...
    public void setRight(SplayTreeIterNode right)
    {
        this.right = right;
        right.setParent(this);
    }

    public void setParent(SplayTreeIterDataNode parent)
    {
        this.parent = parent;
    }
    ...
    public void drawNode(Graphics g)
    {
        ...
        if(newestNode == this)
            currentBackgroundColor = SplayTreeIterColors.NEW_NODE_COLOR;
        else
        if(foundNode == this)
            currentBackgroundColor = SplayTreeIterColors.FOUND_NODE_COLOR;
        else
            currentBackgroundColor = BACKGROUND_COLOR;
