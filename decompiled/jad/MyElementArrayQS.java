...
// Source File Name:   MyElementArrayQS.java
...
public class MyElementArrayQS
    implements Drawable, Selectable, ObjectContainer
{

    public MyElementArrayQS(int xBuffer, int yAxis)
    {
        columGap = 10;
        sequenceNumber = 1;
        elementWidth = 10;
    ...
    public boolean equals(Selectable selectable)
    {
        ...
        {
            MyElementArrayQS elementArray = (MyElementArrayQS)selectable;
