...
// Source File Name:   MSTKGraphAlgorithmCommon.java
...
public class MSTKGraphAlgorithmCommon extends GraphAlgorithmCommon
{
    ...
    MSTKGraphAlgorithmCommon(MSTKGraphMaps p_algorithm, Object p_data)
    {
    ...
    public void startEditLink(Integer p_link_weight)
    {
        ...
        messageDialog = new MessageDialog(Messages.getString("MSTKGraphAlgorithmCommon.3"), false, false);
        messageDialog.setTitle(Messages.getString("MSTKGraphAlgorithmCommon.4"));
    ...
    public void setStartNode(int p_key)
    {
        ...
        if(messageDialog != null)
            messageDialog.dispose();
        messageDialog = new MessageDialog(Messages.getString("MSTKGraphAlgorithmCommon.5"), false, false);
        messageDialog.setTitle(Messages.getString("MSTKGraphAlgorithmCommon.6"));
        messageDialog.setVisible(true);
        m_editLinkStep++;
        m_algorithm.repaint();
    }
    ...
    public void setKeyChangeMode(boolean p_keyChange)
    {
        ...
        if(m_bKeyChangeMode)
        {
            messageDialog = new MessageDialog(Messages.getString("MSTKGraphAlgorithmCommon.7"), false, false);
            messageDialog.setTitle(Messages.getString("MSTKGraphAlgorithmCommon.8"));
            messageDialog.setVisible(true);
        }
    }
    ...
    public void setInsertionMode(boolean p_insertion)
    {
        ...
        if(m_bInsertionMode)
        {
            messageDialog = new MessageDialog(Messages.getString("MSTKGraphAlgorithmCommon.9"), false, false);
            messageDialog.setTitle(Messages.getString("MSTKGraphAlgorithmCommon.10"));
            messageDialog.setVisible(true);
        }
    }
    ...
    public void setDeleteMode(boolean p_deleteMode)
    {
        ...
        if(m_bDeleteMode)
        {
            messageDialog = new MessageDialog(Messages.getString("MSTKGraphAlgorithmCommon.11"), false, false);
            messageDialog.setTitle(Messages.getString("MSTKGraphAlgorithmCommon.12"));
            messageDialog.setVisible(true);
        }
    }
