...
// Source File Name:   MinSpanTreePrimGraphCanvasCommonExt.java
...
public class MinSpanTreePrimGraphCanvasCommonExt extends GraphCanvasCommonExt
{
    ...
    MinSpanTreePrimGraphCanvasCommonExt(GraphMapsCanvasExt p_canvas, GraphMaps p_algorithm)
    {
    ...
    public void setMatrix(Vector p_matrix, int matrix_x, int matrix_y)
    {
        ...
        if(vecAdjacencyMatrix != null)
        {
            ...
            GraphMapsCanvasExt _tmp = m_canvas;
    ...
    private void calculateStructureHeight()
    {
        ...
        for(int i = 0; i < m_algorithm.getNumberOfNodes(); i++)
        {
            ...
            do
            {
                if(root == null)
                    break;
                GraphMapsCanvasExt _tmp1 = m_canvas;
    ...
    {
        if(m_algorithm != null && !m_algorithm.getIsRunning() && value != null && sourceDialog.equals(Messages.getString("MinSpanTreePrimGraphCanvasCommonExt.0")))
    ...
    public void editMatrix(GraphMapsNode p_Node)
    {
        if(m_algorithm != null && !m_algorithm.getIsRunning())
        {
            ...
            m_dlgMatrixEdit = new InputDialog(m_canvas, m_frmMatrixEdit, Messages.getString("MinSpanTreePrimGraphCanvasCommonExt.7"), true, Messages.getString("MinSpanTreePrimGraphCanvasCommonExt.8"), p_Node.getIntValue());
    ...
    public void drawAdjacencyMatrix(Graphics g)
    {
        ...
        g.drawString(Messages.getString("MinSpanTreePrimGraphCanvasCommonExt.9"), MATRIX_X, MATRIX_Y - fm.getHeight());
        GraphMapsCanvasExt _tmp = m_canvas;
        g.drawString(Messages.getString("MinSpanTreePrimGraphCanvasCommonExt.10"), MATRIX_X - fm.stringWidth(Messages.getString("MinSpanTreePrimGraphCanvasCommonExt.11")), (MATRIX_Y + 20) - fm.getMaxDescent());
        g.drawString(Messages.getString("MinSpanTreePrimGraphCanvasCommonExt.12"), MATRIX_X, MATRIX_Y - fm.getHeight() * 2);
        g.setColor(m_canvas.getTextColor());
        for(int i = 0; i < vecAdjacencyMatrix.size(); i++)
        {
            String label = Integer.toString(i);
            GraphMapsCanvasExt _tmp1 = m_canvas;
            GraphMapsCanvasExt _tmp2 = m_canvas;
            g.drawString(label, MATRIX_X + 20 * i + (20 - fm.stringWidth(label)) / 2, MATRIX_Y - fm.getMaxDescent());
            GraphMapsCanvasExt _tmp3 = m_canvas;
    ...
    public void drawAdjacencyStructure(Graphics g)
    {
        ...
        g.setColor(Color.blue);
        FontMetrics fm = g.getFontMetrics();
        g.drawString(Messages.getString("MinSpanTreePrimGraphCanvasCommonExt.13"), earrAdjacencyStructure.getLocation().x, STRUCTURE_Y - fm.getHeight() * 2);
        g.setColor(m_canvas.getTextColor());
...
label0:
        for(int i = 0; i < m_algorithm.getNumberOfNodes(); i++)
        {
            ...
            do
            {
                ...
                GraphMapsCanvasExt _tmp2 = m_canvas;
                GraphMapsCanvasExt _tmp3 = m_canvas;
                GraphMapsCanvasExt _tmp4 = m_canvas;
                ...
                GraphMapsCanvasExt _tmp5 = m_canvas;
