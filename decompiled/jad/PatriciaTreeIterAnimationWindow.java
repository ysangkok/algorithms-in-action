...
// Source File Name:   PatriciaTreeIterAnimationWindow.java
...
public class PatriciaTreeIterAnimationWindow extends AnimationWindow
{
    ...
    public PatriciaTreeIterAnimationWindow(AlgorithmCanvas canvas, AlgorithmThread thread, Applet applet)
    {
        ...
        RestartButton restart = new RestartButton(Messages.getString("PatriciaTreeIterAnimationWindow.3"), Messages.getString("PatriciaTreeIterAnimationWindow.4"), this, thread);
        ...
        addControlListener((ControlListener)((PatriciaTreeIterThread)thread).getAlgorithm());
    ...
    protected static final String FRAME_TITLE = Messages.getString("PatriciaTreeIterAnimationWindow.2");
