...
// Source File Name:   RadixTrieIterInternalNode.java
...
public class RadixTrieIterInternalNode extends RadixTrieIterNode
{
    ...
    RadixTrieIterInternalNode()
    {
        ...
        left = new RadixTrieIterNullNode(this);
        right = new RadixTrieIterNullNode(this);
    }
    ...
    public void setLeft(RadixTrieIterNode left)
    {
        this.left = left;
    ...
    public void setRight(RadixTrieIterNode right)
    {
        this.right = right;
