...
// Source File Name:   RadixTrieExternalNode.java
...
public class RadixTrieExternalNode extends RadixTrieNode
{
    ...
    RadixTrieExternalNode(RadixTrieDataItem dataItem)
    {
        backgroundColor = RadixTrieColors.DEFAULT_NODE_COLOR;
    ...
    public static void setCompareNode(RadixTrieExternalNode newCompareNode)
    {
    ...
    public void drawNode(Graphics g)
    {
        ...
        if(newestNode == this)
            currentBackgroundColor = RadixTrieColors.NEW_NODE_COLOR;
        else
        if(compareNode == this)
            currentBackgroundColor = RadixTrieColors.COMPARE_NODE_COLOR;
        else
            currentBackgroundColor = backgroundColor;
