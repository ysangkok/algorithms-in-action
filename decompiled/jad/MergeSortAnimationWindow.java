...
// Source File Name:   MergeSortAnimationWindow.java
...
public class MergeSortAnimationWindow extends AnimationWindow
{
    ...
    public MergeSortAnimationWindow(AlgorithmCanvas canvas, AlgorithmThread thread, Applet applet)
    {
    ...
    {
        ((MergeSortThread)thread).resetSeed();
        super.resetThread();
    }

    protected static final String BUILD_DATE = "15/2/2007";
    protected static final String BUILD_BY = "M. Tabbara";
    protected static final String FRAME_TITLE = Messages.getString("MergeSortAnimationWindow.2");
