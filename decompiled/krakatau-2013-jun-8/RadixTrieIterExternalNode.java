public class RadixTrieIterExternalNode extends RadixTrieIterNode {
    ...
    final protected static int NODE_X_GAP = 18;
    ...
    RadixTrieIterExternalNode(com.cim.AIA.DataItem a)
    {
        super();
        java.awt.Color a0 = RadixTrieIterColors.DEFAULT_NODE_COLOR;
    ...
    public static void setCompareNode(RadixTrieIterExternalNode a)
    {
        RadixTrieIterExternalNode.compareNode = a;
    }
    ...
    public void setPosition(java.awt.Point a)
    {
        ...
        RadixTrieIterExternalNode.upperLeft = a0;
        java.awt.Point a1 = RadixTrieIterExternalNode.upperLeft;
        int i = a.x;
        int i0 = i - 9;
        a1.x = i0;
        java.awt.Point a2 = RadixTrieIterExternalNode.upperLeft;
        int i1 = a.y;
        int i2 = i1 - 9;
        a2.y = i2;
        java.awt.Point a3 = new java.awt.Point();
        RadixTrieIterExternalNode.lowerRight = a3;
        java.awt.Point a4 = RadixTrieIterExternalNode.lowerRight;
        int i3 = a.x;
        int i4 = i3 + 9;
        a4.x = i4;
        java.awt.Point a5 = RadixTrieIterExternalNode.lowerRight;
        int i5 = a.y;
        int i6 = i5 + 9;
        a5.y = i6;
    ...
    protected synchronized java.awt.Point layout(int i, int i0)
    {
        ...
        int i7 = a4.y;
        int i8 = i7 - 9;
        java.awt.Point a5 = RadixTrieIterExternalNode.upperLeft;
        int i9 = a5.y;
        if(i8 < i9)
        {
            java.awt.Point a6 = RadixTrieIterExternalNode.upperLeft;
        ...
        int i12 = a8.x;
        int i13 = i12 + 9;
        java.awt.Point a9 = RadixTrieIterExternalNode.lowerRight;
        int i14 = a9.x;
        if(i13 > i14)
        {
            java.awt.Point a10 = RadixTrieIterExternalNode.lowerRight;
        ...
        int i17 = a12.y;
        int i18 = i17 + 9;
        java.awt.Point a13 = RadixTrieIterExternalNode.lowerRight;
        int i19 = a13.y;
        if(i18 > i19)
        {
            java.awt.Point a14 = RadixTrieIterExternalNode.lowerRight;
    ...
    public java.awt.Rectangle getRectangle()
    {
        java.awt.Point a = this.position;
        this.setPosition(a);
        java.awt.Point a0 = RadixTrieIterExternalNode.upperLeft;
        int i = a0.x;
        java.awt.Point a1 = RadixTrieIterExternalNode.upperLeft;
        int i0 = a1.y;
        java.awt.Point a2 = RadixTrieIterExternalNode.lowerRight;
        int i1 = a2.x;
        java.awt.Point a3 = RadixTrieIterExternalNode.upperLeft;
        int i2 = a3.x;
        int i3 = i1 - i2;
        java.awt.Point a4 = RadixTrieIterExternalNode.lowerRight;
        int i4 = a4.y;
    ...
    {
        RadixTrieIterInternalNode a0 = this.parent;
        if(a0 == null)
        {
            this.drawNode(a);
        }
    ...
    public void drawNode(java.awt.Graphics a)
    {
        ...
        RadixTrieIterExternalNode a4 = RadixTrieIterExternalNode.newestNode;
        label1: {
            label0: {
                if(a4 != this)
                {
                ...
                java.awt.Color a5 = RadixTrieIterColors.NEW_NODE_COLOR;
                this.currentBackgroundColor = a5;
                break label1;
            }
            RadixTrieIterExternalNode a6 = RadixTrieIterExternalNode.compareNode;
            if(a6 != this)
            {
            ...
            {
                java.awt.Color a8 = RadixTrieIterColors.COMPARE_NODE_COLOR;
