public class PatriciaTreeIterThread extends com.cim.AIA.AlgorithmThread {
    public PatriciaTreeIterThread(com.cim.AIA.Copyable a, com.cim.AIA.AlgorithmWindow a0)
    {
        super(a, a0);
    }
    ...
    public com.cim.AIA.Algorithm createAlgorithm(com.cim.AIA.Copyable a)
    {
        ...
        PatriciaTreeIter a2 = new PatriciaTreeIter((com.cim.AIA.AlgorithmThread)this, a1);
        return a2;
    }
