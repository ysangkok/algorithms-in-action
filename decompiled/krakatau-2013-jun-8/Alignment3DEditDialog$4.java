class Alignment3DEditDialog$4 implements java.awt.event.AdjustmentListener {
    final Alignment val$algorithm;
    final Alignment3DEditDialog this$0;
    
    Alignment3DEditDialog$4(Alignment3DEditDialog a, Alignment a0)
    {
        this.this$0 = a;
    ...
    public void adjustmentValueChanged(java.awt.event.AdjustmentEvent a)
    {
        ...
        java.awt.Scrollbar a2 = a1.yScroll;
        int i = a2.getValue();
        a0.rotateY(i);
    }
}