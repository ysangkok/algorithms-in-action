public class MinSpanTreePrimGraphMapsCanvas extends aia.graph.common.GraphMapsCanvas implements aia.graph.common.GraphDialogEventHandler {
    ...
    {
        MinSpanTreePrimGraphCanvasCommon a = this.commons;
        a.processDialogEvent(s, s0);
    }
    
    public void processMouseMotionEvent(java.awt.event.MouseEvent a)
    {
        MinSpanTreePrimGraphCanvasCommon a0 = this.commons;
        int i = a.getX();
        int i0 = a.getY();
        a0.mouseMoved(i, i0);
    }
    ...
    public void displayAlgorithm(java.awt.Graphics a)
    {
        ...
        MinSpanTreePrimGraphCanvasCommon a4 = this.commons;
        if(a4 != null)
        {
            MinSpanTreePrimGraphCanvasCommon a5 = this.commons;
            a5.drawLinks(a);
            MinSpanTreePrimGraphCanvasCommon a6 = this.commons;
            a6.drawNodes(a);
        }
    }
    ...
    public void processRepaintEvent(com.cim.AIA.RepaintEvent a)
    {
        ...
        label0: {
            ...
            if(a4 == null)
            {
                ...
                MinSpanTreePrimGraphCanvasCommon a6 = new MinSpanTreePrimGraphCanvasCommon((aia.graph.common.GraphMapsCanvas)this, a5);
                this.commons = a6;
            }
            this.removeAllSelectables();
            MinSpanTreePrimGraphCanvasCommon a7 = this.commons;
            aia.graph.common.GraphMaps a8 = this.graphMaps;
            java.util.Vector a9 = a8.getNodes();
            a7.setNodes(a9, 30);
            MinSpanTreePrimGraphCanvasCommon a10 = this.commons;
            aia.graph.common.GraphMaps a11 = this.graphMaps;
            java.util.Vector a12 = a11.getLinks();
            a10.setLinks(a12);
            MinSpanTreePrimGraphCanvasCommon a13 = this.commons;
