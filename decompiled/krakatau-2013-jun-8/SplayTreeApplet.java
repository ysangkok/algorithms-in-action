public class SplayTreeApplet extends com.cim.AIA.AlgorithmApplet {
    ...
    public SplayTreeApplet()
    {
        ...
        String s = SplayTreeApplet.ALGORITHM_FILE_NAME;
        this.algorithmFileName = s;
        String s0 = SplayTreeApplet.EXPLANATION_TITLE;
        this.explanationTitle = s0;
        String s1 = SplayTreeApplet.EXPLANATION_FILE_NAME;
        this.explanationFileName = s1;
    }
    
    public com.cim.AIA.Copyable getInitialData()
    {
        int[] a = SplayTreeAnimationWindow.DEFAULT_DATA;
    ...
    {
        Object a1 = a;
        SplayTreeThread a2 = new SplayTreeThread((com.cim.AIA.Copyable)a1, a0);
        return a2;
    }
    
    public com.cim.AIA.AlgorithmCanvas getAlgorithmCanvas()
    {
        SplayTreeCanvas a = new SplayTreeCanvas();
        return a;
    }
    ...
    {
        SplayTreeAnimationWindow a2 = new SplayTreeAnimationWindow(a, a0, a1);
        return a2;
    }
    ...
    protected void otherInitialisation()
    {
        ...
        SplayTree dummy = (SplayTree)a;
        SplayTree a0 = (SplayTree)a;
    ...
    static
    {
        String s = localization.Messages.getString("SplayTreeApplet.1");
        SplayTreeApplet.ALGORITHM_FILE_NAME = s;
        String s0 = localization.Messages.getString("SplayTreeApplet.2");
        SplayTreeApplet.EXPLANATION_TITLE = s0;
        String s1 = localization.Messages.getString("SplayTreeApplet.3");
        SplayTreeApplet.EXPLANATION_FILE_NAME = s1;
    }
}