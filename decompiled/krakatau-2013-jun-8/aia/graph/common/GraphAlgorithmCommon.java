...
public class GraphAlgorithmCommon {
    ...
    public GraphAlgorithmCommon(aia.graph.common.GraphMaps a, Object a0)
    {
        super();
        this.m_bOmniDirectional = true;
        this.m_nZoomFactor = 1;
    ...
    public void endEditLink()
    {
        ...
        this.m_startNode = -10;
        this.m_endNode = -10;
        com.cim.common.MessageDialog a = aia.graph.common.GraphAlgorithmCommon.messageDialog;
        if(a != null)
        {
            com.cim.common.MessageDialog a0 = aia.graph.common.GraphAlgorithmCommon.messageDialog;
            a0.dispose();
        }
        aia.graph.common.GraphAlgorithmCommon.messageDialog = null;
    ...
    public void setDeleteMode(boolean b)
    {
        ...
        label1: {
            ...
            if(a0 != null)
            {
                com.cim.common.MessageDialog a1 = aia.graph.common.GraphAlgorithmCommon.messageDialog;
                a1.dispose();
            }
            int i1 = this.m_bDeleteMode?1:0;
            if(i1 != 0)
            {
                String s = localization.Messages.getString("GraphAlgorithmCommon.11");
                com.cim.common.MessageDialog a2 = new com.cim.common.MessageDialog(s, false, false);
                aia.graph.common.GraphAlgorithmCommon.messageDialog = a2;
                com.cim.common.MessageDialog a3 = aia.graph.common.GraphAlgorithmCommon.messageDialog;
                String s0 = localization.Messages.getString("GraphAlgorithmCommon.12");
                a3.setTitle(s0);
                com.cim.common.MessageDialog a4 = aia.graph.common.GraphAlgorithmCommon.messageDialog;
                a4.setVisible(true);
            }
        }
    }
    ...
    public void setInsertionMode(boolean b)
    {
        ...
        label1: {
            ...
            if(i1 != 0)
            {
                String s = localization.Messages.getString("GraphAlgorithmCommon.9");
                com.cim.common.MessageDialog a2 = new com.cim.common.MessageDialog(s, false, false);
                aia.graph.common.GraphAlgorithmCommon.messageDialog = a2;
                com.cim.common.MessageDialog a3 = aia.graph.common.GraphAlgorithmCommon.messageDialog;
                String s0 = localization.Messages.getString("GraphAlgorithmCommon.10");
                a3.setTitle(s0);
                com.cim.common.MessageDialog a4 = aia.graph.common.GraphAlgorithmCommon.messageDialog;
                a4.setVisible(true);
            }
    ...
    public void setKeyChangeMode(boolean b)
    {
        ...
        label1: {
            ...
            if(i1 != 0)
            {
                String s = localization.Messages.getString("GraphAlgorithmCommon.7");
                com.cim.common.MessageDialog a2 = new com.cim.common.MessageDialog(s, false, false);
                aia.graph.common.GraphAlgorithmCommon.messageDialog = a2;
                com.cim.common.MessageDialog a3 = aia.graph.common.GraphAlgorithmCommon.messageDialog;
                String s0 = localization.Messages.getString("GraphAlgorithmCommon.8");
                a3.setTitle(s0);
                com.cim.common.MessageDialog a4 = aia.graph.common.GraphAlgorithmCommon.messageDialog;
                a4.setVisible(true);
            }
    ...
    public void setStartNode(int i)
    {
        ...
        String s = localization.Messages.getString("GraphAlgorithmCommon.5");
        com.cim.common.MessageDialog a1 = new com.cim.common.MessageDialog(s, false, false);
        aia.graph.common.GraphAlgorithmCommon.messageDialog = a1;
        com.cim.common.MessageDialog a2 = aia.graph.common.GraphAlgorithmCommon.messageDialog;
        String s0 = localization.Messages.getString("GraphAlgorithmCommon.6");
        a2.setTitle(s0);
        com.cim.common.MessageDialog a3 = aia.graph.common.GraphAlgorithmCommon.messageDialog;
        a3.setVisible(true);
        int i0 = this.m_editLinkStep;
    ...
    public void startEditLink(Integer a)
    {
        ...
        label1: {
            ...
            String s = localization.Messages.getString("GraphAlgorithmCommon.3");
            com.cim.common.MessageDialog a3 = new com.cim.common.MessageDialog(s, false, false);
            aia.graph.common.GraphAlgorithmCommon.messageDialog = a3;
            com.cim.common.MessageDialog a4 = aia.graph.common.GraphAlgorithmCommon.messageDialog;
            String s0 = localization.Messages.getString("GraphAlgorithmCommon.4");
            a4.setTitle(s0);
            com.cim.common.MessageDialog a5 = aia.graph.common.GraphAlgorithmCommon.messageDialog;
            a5.setVisible(true);
