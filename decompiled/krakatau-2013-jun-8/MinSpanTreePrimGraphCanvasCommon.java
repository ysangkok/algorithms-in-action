public class MinSpanTreePrimGraphCanvasCommon {
    ...
    MinSpanTreePrimGraphCanvasCommon(aia.graph.common.GraphMapsCanvas a, aia.graph.common.GraphMaps a0)
    {
        super();
        this.GRAPH_X = 30;
        this.GRAPH_Y = 30;
    ...
    public void processDialogEvent(String s, String s0)
    {
        ...
        label0: {
            ...
            String s1 = localization.Messages.getString("MinSpanTreePrimGraphCanvasCommon.0");
            ...
            String s2 = localization.Messages.getString("MinSpanTreePrimGraphCanvasCommon.1");
        ...
        label4: {
            ...
            label6: {
                label5: {
                    ...
                    String s = localization.Messages.getString("MinSpanTreePrimGraphCanvasCommon.2");
                    String s0 = localization.Messages.getString("MinSpanTreePrimGraphCanvasCommon.3");
                ...
                label9: {
                    ...
                    if(i27 != 0)
                    {
                        ...
                        String s1 = localization.Messages.getString("MinSpanTreePrimGraphCanvasCommon.4");
                        String s2 = localization.Messages.getString("MinSpanTreePrimGraphCanvasCommon.5");
