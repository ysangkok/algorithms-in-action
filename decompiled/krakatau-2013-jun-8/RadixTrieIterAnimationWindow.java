public class RadixTrieIterAnimationWindow extends com.cim.AIA.AnimationWindow {
    ...
    public RadixTrieIterAnimationWindow(com.cim.AIA.AlgorithmCanvas a, com.cim.AIA.AlgorithmThread a0, java.applet.Applet a1)
    {
        super(a, a0, a1);
        this.buildDate = "Build Date";
        this.buildBy = "Your Initial.Your Surname";
        String s = RadixTrieIterAnimationWindow.FRAME_TITLE;
        this.frameTitle = s;
        ...
        String s10 = localization.Messages.getString("RadixTrieIterAnimationWindow.3");
        String s11 = localization.Messages.getString("RadixTrieIterAnimationWindow.4");
        ...
        String s12 = RadixTrieIterAnimationWindow.DEFAULT_LABEL;
        int[] a8 = RadixTrieIterAnimationWindow.DEFAULT_DATA;
        ...
        String s13 = RadixTrieIterAnimationWindow.RANDOM_LABEL;
        com.cim.AIA.RandomIntArrayDataSelection a10 = new com.cim.AIA.RandomIntArrayDataSelection(s13, false, (com.cim.AIA.AnimationWindow)this, 5, 20, 1, 99);
        ...
        String s14 = RadixTrieIterAnimationWindow.USER_SELECTION_LABEL;
        StringBuilder a12 = a11.append(s14);
        StringBuilder a13 = a12.append("...");
        String s15 = a13.toString();
        String s16 = RadixTrieIterAnimationWindow.USER_SELECTION_LABEL;
        com.cim.AIA.UserSelectionIntArrayDataSelection a14 = new com.cim.AIA.UserSelectionIntArrayDataSelection(s15, false, (com.cim.AIA.AnimationWindow)this, s16, 1, 99, 5, 20);
        a14.setReinitialiseAlgorithm(true);
        a14.setClearAlgorithmState(true);
        this.addDataSelection((com.cim.AIA.DataSelection)a14);
        RadixTrieIterThread dummy = (RadixTrieIterThread)a0;
        RadixTrieIterThread a15 = (RadixTrieIterThread)a0;
    ...
    static
    {
        String s = localization.Messages.getString("RadixTrieIterAnimationWindow.2");
        RadixTrieIterAnimationWindow.FRAME_TITLE = s;
        int[] a = new int[8];
        a[0] = 1;
        a[1] = 21;
        a[2] = 20;
        ...
        a[6] = 30;
        a[7] = 15;
        RadixTrieIterAnimationWindow.DEFAULT_DATA = a;
    }
}