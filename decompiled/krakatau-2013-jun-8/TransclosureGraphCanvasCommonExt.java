public class TransclosureGraphCanvasCommonExt extends aia.graph.common.GraphMapsCanvasExt {
    ...
    TransclosureGraphCanvasCommonExt(aia.graph.common.GraphMapsCanvasExt a, aia.graph.common.GraphMaps a0)
    {
        super();
    ...
    public void processDialogEvent(String s, String s0)
    {
        ...
        label0: {
            ...
            String s1 = localization.Messages.getString("TransclosureGraphCanvasCommonExt.0");
    ...
    public void editMatrix(aia.graph.common.GraphMapsNode a)
    {
        ...
        label0: {
            ...
            if(i == 0)
            {
                ...
                String s = localization.Messages.getString("TransclosureGraphCanvasCommonExt.1");
                String s0 = localization.Messages.getString("TransclosureGraphCanvasCommonExt.2");
    ...
    public void drawAdjacencyMatrix(java.awt.Graphics a)
    {
        ...
        label1: {
            ...
            a.setColor(a3);
            String s = localization.Messages.getString("TransclosureGraphCanvasCommonExt.3");
            int i0 = this.MATRIX_X;
            int i1 = this.MATRIX_Y;
            int i2 = a2.getHeight();
            int i3 = i1 - i2;
            a.drawString(s, i0, i3);
            String s0 = localization.Messages.getString("TransclosureGraphCanvasCommonExt.4");
            int i4 = this.MATRIX_X;
            String s1 = localization.Messages.getString("TransclosureGraphCanvasCommonExt.5");
            ...
            String s2 = localization.Messages.getString("TransclosureGraphCanvasCommonExt.6");
    ...
    public void drawAdjacencyStructure(java.awt.Graphics a)
    {
        ...
        label1: {
            ...
            String s = localization.Messages.getString("TransclosureGraphCanvasCommonExt.7");
