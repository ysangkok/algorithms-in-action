...
public class DigitalElementArray implements com.cim.AIA.Drawable, com.cim.AIA.Selectable {
    ...
    public DigitalElementArray(int i, int i0)
    {
        super();
    ...
    public void draw(java.awt.Graphics a)
    {
        ...
        if(s != null)
        {
            java.awt.Color a10 = com.cim.AIA.DigitalElementArray.DEFAULT_TEXT_COLOR;
            a.setColor(a10);
    ...
    public void unHighlight()
    {
        ...
        while(true)
        {
            ...
            if(a3 != null)
            {
                ...
                java.awt.Color a6 = com.cim.AIA.DigitalElementArray.DEFAULT_BACKGROUND_COLOR;
    ...
    static
    {
        ...
        com.cim.AIA.DigitalElementArray.DEFAULT_TEXT_COLOR = a;
        java.awt.Color a0 = java.awt.Color.white;
        com.cim.AIA.DigitalElementArray.DEFAULT_BACKGROUND_COLOR = a0;
    }
}