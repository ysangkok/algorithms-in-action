...
public class ElementArray implements com.cim.AIA.Drawable, com.cim.AIA.Selectable, com.cim.AIA.ObjectContainer {
    ...
    public ElementArray(int i, int i0)
    {
        super();
        this.columGap = 10;
    ...
    public boolean equals(com.cim.AIA.Selectable a)
    {
        ...
        label1: {
            Object a0 = null;
            label0: {
                int i0 = a instanceof com.cim.AIA.ElementArray?1:0;
                a0 = a;
                if(i0 != 0)
                {
                    break label0;
            ...
            com.cim.AIA.ElementArray a1 = (com.cim.AIA.ElementArray)a0;
