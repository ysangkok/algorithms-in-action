public class MinSpanTreePrimGraphMapsAnimationWindowExt extends com.cim.AIA.AnimationWindow {
    ...
    public MinSpanTreePrimGraphMapsAnimationWindowExt(com.cim.AIA.AlgorithmCanvas a, com.cim.AIA.AlgorithmThread a0, java.applet.Applet a1)
    {
        super(a, a0, a1);
        ...
        String s = localization.Messages.getString("MinSpanTreePrimGraphMapsAnimationWindowExt.1");
        this.HIDE_MATRIX_LABEL = s;
        String s0 = localization.Messages.getString("MinSpanTreePrimGraphMapsAnimationWindowExt.2");
        this.SHOW_MATRIX_LABEL = s0;
        String s1 = localization.Messages.getString("MinSpanTreePrimGraphMapsAnimationWindowExt.3");
        this.HIDE_STRUCTURE_LABEL = s1;
        String s2 = localization.Messages.getString("MinSpanTreePrimGraphMapsAnimationWindowExt.4");
        this.SHOW_STRUCTURE_LABEL = s2;
        String s3 = MinSpanTreePrimGraphMapsAnimationWindowExt.FRAME_TITLE;
        this.frameTitle = s3;
        ...
        MinSpanTreePrimGraphMapsAnimationWindowExt$1 a8 = new MinSpanTreePrimGraphMapsAnimationWindowExt$1(this);
        ...
        MinSpanTreePrimGraphMapsThread a10 = (MinSpanTreePrimGraphMapsThread)a0;
    ...
    static
    {
        String s = localization.Messages.getString("MinSpanTreePrimGraphMapsAnimationWindowExt.0");
        MinSpanTreePrimGraphMapsAnimationWindowExt.FRAME_TITLE = s;
    }
}