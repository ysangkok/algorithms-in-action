public class MSTKGraphMapsAnimationWindowExt extends com.cim.AIA.AnimationWindow {
    ...
    public MSTKGraphMapsAnimationWindowExt(com.cim.AIA.AlgorithmCanvas a, com.cim.AIA.AlgorithmThread a0, java.applet.Applet a1)
    {
        super(a, a0, a1);
        ...
        String s = localization.Messages.getString("MSTKGraphMapsAnimationWindowExt.1");
        this.HIDE_MATRIX_LABEL = s;
        String s0 = localization.Messages.getString("MSTKGraphMapsAnimationWindowExt.2");
        this.SHOW_MATRIX_LABEL = s0;
        String s1 = localization.Messages.getString("MSTKGraphMapsAnimationWindowExt.3");
        this.HIDE_STRUCTURE_LABEL = s1;
        String s2 = localization.Messages.getString("MSTKGraphMapsAnimationWindowExt.4");
        this.SHOW_STRUCTURE_LABEL = s2;
        String s3 = MSTKGraphMapsAnimationWindowExt.FRAME_TITLE;
        this.frameTitle = s3;
        ...
        MSTKGraphMapsAnimationWindowExt$1 a8 = new MSTKGraphMapsAnimationWindowExt$1(this);
        ...
        MSTKGraphMapsThread a10 = (MSTKGraphMapsThread)a0;
    ...
    static
    {
        String s = localization.Messages.getString("MSTKGraphMapsAnimationWindowExt.0");
        MSTKGraphMapsAnimationWindowExt.FRAME_TITLE = s;
    }
}