class RedBlackTreeAnimationWindow$4 implements java.awt.event.ActionListener {
    final RedBlackTree val$redBlackTree;
    final RedBlackTreeAnimationWindow this$0;
    
    RedBlackTreeAnimationWindow$4(RedBlackTreeAnimationWindow a, RedBlackTree a0)
    {
        this.this$0 = a;
    ...
    public void actionPerformed(java.awt.event.ActionEvent a)
    {
        ...
        label1: {
            label0: {
                ...
                String s = localization.Messages.getString("RedBlackTreeAnimationWindow.14");
                com.cim.common.MessageDialog a1 = new com.cim.common.MessageDialog(s, true, true);
                String s0 = localization.Messages.getString("RedBlackTreeAnimationWindow.15");
                a1.setTitle(s0);
                a1.setVisible(true);
                break label1;
            }
            ...
            if(i0 == 0)
            {
                String s1 = localization.Messages.getString("RedBlackTreeAnimationWindow.16");
                com.cim.common.MessageDialog a3 = new com.cim.common.MessageDialog(s1, true, true);
                String s2 = localization.Messages.getString("RedBlackTreeAnimationWindow.17");
                a3.setTitle(s2);
                a3.setVisible(true);
            }
            else
