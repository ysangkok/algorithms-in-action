class Alignment3DEditDialog$6 implements java.awt.event.AdjustmentListener {
    final Alignment val$algorithm;
    final Alignment3DEditDialog this$0;
    
    Alignment3DEditDialog$6(Alignment3DEditDialog a, Alignment a0)
    {
        this.this$0 = a;
    ...
    public void adjustmentValueChanged(java.awt.event.AdjustmentEvent a)
    {
        ...
        java.awt.Scrollbar a2 = a1.xTranslate;
        int i = a2.getValue();
        a0.translateX(i);
    }
}