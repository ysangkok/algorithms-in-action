public class RadixTrieIterInternalNode extends RadixTrieIterNode {
    ...
    RadixTrieIterInternalNode()
    {
        ...
        RadixTrieIterNullNode a10 = new RadixTrieIterNullNode(this);
        this.left = a10;
        RadixTrieIterNullNode a11 = new RadixTrieIterNullNode(this);
        this.right = a11;
    }
    ...
    public void setPosition(java.awt.Point a)
    {
        ...
        RadixTrieIterInternalNode.upperLeft = a0;
        java.awt.Point a1 = RadixTrieIterInternalNode.upperLeft;
        int i = a.y;
        int i0 = i - 3;
        a1.y = i0;
        java.awt.Point a2 = RadixTrieIterInternalNode.upperLeft;
        int i1 = a.x;
        int i2 = i1 - 3;
        a2.x = i2;
        java.awt.Point a3 = new java.awt.Point();
        RadixTrieIterInternalNode.lowerRight = a3;
        java.awt.Point a4 = RadixTrieIterInternalNode.lowerRight;
        int i3 = a.y;
        int i4 = i3 + 3;
        a4.y = i4;
        java.awt.Point a5 = RadixTrieIterInternalNode.lowerRight;
        int i5 = a.x;
        int i6 = i5 + 3;
        a5.x = i6;
        RadixTrieIterNode a6 = this.left;
        if(a6 != null)
        {
            RadixTrieIterNode a7 = this.left;
            int i7 = a.x;
            int i8 = i7 - 8;
            int i9 = a.y;
            int i10 = i9 + 20;
            java.awt.Point a8 = a7.layout(i8, i10);
            RadixTrieIterNode a9 = this.left;
            int i11 = a.x;
            int i12 = a.x;
            int i13 = i11 + i12;
            int i14 = a8.x;
        ...
        RadixTrieIterNode a12 = this.right;
        if(a12 != null)
        {
            RadixTrieIterNode a13 = this.right;
            int i19 = a11.x;
            int i20 = i19 + 4;
            int i21 = a11.y;
            int i22 = i21 + 20;
    ...
    protected synchronized java.awt.Point layout(int i, int i0)
    {
        ...
        RadixTrieIterNode a2 = this.left;
        if(a2 == null)
        {
            a = a1;
        }
        ...
        {
            RadixTrieIterNode a3 = this.left;
            int i1 = i0 + 20;
        ...
        int i4 = a.x;
        int i5 = i4 - 3;
        java.awt.Point a5 = RadixTrieIterInternalNode.upperLeft;
        int i6 = a5.x;
        if(i5 < i6)
        {
            java.awt.Point a6 = RadixTrieIterInternalNode.upperLeft;
            int i7 = a.x;
            int i8 = i7 - 3;
            a6.x = i8;
        }
        int i9 = a.y;
        int i10 = i9 - 3;
        java.awt.Point a7 = RadixTrieIterInternalNode.upperLeft;
        int i11 = a7.y;
        if(i10 < i11)
        {
            java.awt.Point a8 = RadixTrieIterInternalNode.upperLeft;
            int i12 = a.y;
            int i13 = i12 - 3;
            a8.y = i13;
        }
        int i14 = a.x;
        int i15 = i14 + 3;
        java.awt.Point a9 = RadixTrieIterInternalNode.lowerRight;
        int i16 = a9.x;
        if(i15 > i16)
        {
            java.awt.Point a10 = RadixTrieIterInternalNode.lowerRight;
            int i17 = a.x;
            int i18 = i17 + 3;
            a10.x = i18;
        }
        int i19 = a.y;
        int i20 = i19 + 3;
        java.awt.Point a11 = RadixTrieIterInternalNode.lowerRight;
        int i21 = a11.y;
        if(i20 > i21)
        {
            java.awt.Point a12 = RadixTrieIterInternalNode.lowerRight;
            int i22 = a.y;
            int i23 = i22 + 3;
            a12.y = i23;
        }
        ...
        {
            RadixTrieIterNode a14 = this.right;
            int i24 = a.x;
            int i25 = i24 + 4;
            int i26 = a.y;
            int i27 = i26 + 20;
    ...
    public java.awt.Rectangle getRectangle()
    {
        ...
        java.awt.Point a2 = RadixTrieIterInternalNode.upperLeft;
        int i = a2.x;
        java.awt.Point a3 = RadixTrieIterInternalNode.upperLeft;
        int i0 = a3.y;
        java.awt.Point a4 = RadixTrieIterInternalNode.lowerRight;
        int i1 = a4.x;
        java.awt.Point a5 = RadixTrieIterInternalNode.upperLeft;
        int i2 = a5.x;
        int i3 = i1 - i2;
        java.awt.Point a6 = RadixTrieIterInternalNode.lowerRight;
        int i4 = a6.y;
        java.awt.Point a7 = RadixTrieIterInternalNode.upperLeft;
        int i5 = a7.y;
        int i6 = i4 - i5;
    ...
    public void draw(java.awt.Graphics a)
    {
        ...
        a.setColor(a0);
        RadixTrieIterNode a1 = this.left;
        label1: {
            label0: {
                if(a1 != null)
                {
            ...
            label2: {
                ...
                RadixTrieIterNode a8 = this.left;
                ...
                if(i6 == 0)
                {
                    ...
                    int i8 = a10.y;
                    RadixTrieIterNode a11 = this.left;
                    java.awt.Point a12 = a11.position;
                    int i9 = a12.x;
                    RadixTrieIterNode a13 = this.left;
                ...
                else
                {
                    ...
                    int i12 = a18.y;
                    RadixTrieIterNode a19 = this.left;
                    java.awt.Point a20 = a19.position;
                    int i13 = a20.x;
                    RadixTrieIterNode a21 = this.left;
            ...
            RadixTrieIterNode a25 = this.left;
            a25.draw(a);
        }
        RadixTrieIterNode a26 = this.right;
        label4: {
            label3: {
                if(a26 != null)
                {
            ...
            RadixTrieIterNode a31 = this.right;
            ...
            label5: {
                ...
                RadixTrieIterNode a33 = this.right;
                ...
                if(i22 == 0)
                {
                    ...
                    int i24 = a35.y;
                    RadixTrieIterNode a36 = this.right;
                    java.awt.Point a37 = a36.position;
                    int i25 = a37.x;
                    RadixTrieIterNode a38 = this.right;
                ...
                else
                {
                    ...
                    int i28 = a43.y;
                    RadixTrieIterNode a44 = this.right;
                    java.awt.Point a45 = a44.position;
                    int i29 = a45.x;
                    RadixTrieIterNode a46 = this.right;
            ...
            RadixTrieIterNode a50 = this.right;
            a50.draw(a);
        }
        RadixTrieIterInternalNode a51 = this.parent;
        if(a51 == null)
        {
            this.drawNode(a);
        }
        RadixTrieIterNode a52 = this.left;
        if(a52 != null)
        {
            RadixTrieIterNode a53 = this.left;
            a53.drawNode(a);
        }
        RadixTrieIterNode a54 = this.right;
        if(a54 != null)
        {
            RadixTrieIterNode a55 = this.right;
            a55.drawNode(a);
        }
    }
    ...
    public void setLeft(RadixTrieIterNode a)
    {
        this.left = a;
        RadixTrieIterNode a0 = this.left;
        a0.parent = this;
    ...
    public void setRight(RadixTrieIterNode a)
    {
        this.right = a;
        RadixTrieIterNode a0 = this.right;
        a0.parent = this;
        com.cim.AIA.HierarchyTree a1 = this.hierarchyTree;
        com.cim.AIA.HierarchyTree a2 = this.hierarchyTree;
    ...
    {
        RadixTrieIterNode a = this.left;
        return a;
    }
    
    public RadixTrieIterNode getRight()
    {
        RadixTrieIterNode a = this.right;
        return a;
    }
