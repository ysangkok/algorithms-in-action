public class RadixTrieMultiDigitalElementArray implements com.cim.AIA.Drawable, com.cim.AIA.Selectable {
    ...
    public RadixTrieMultiDigitalElementArray(int i, int i0, boolean b)
    {
        this(i, i0);
        int i1 = b?1:0;
    ...
    public RadixTrieMultiDigitalElementArray(int i, int i0)
    {
        super();
    ...
    public void draw(java.awt.Graphics a)
    {
        ...
        if(s != null)
        {
            java.awt.Color a10 = RadixTrieMultiDigitalElementArray.DEFAULT_TEXT_COLOR;
            a.setColor(a10);
    ...
    public void unHighlight()
    {
        ...
        while(true)
        {
            ...
            if(a3 != null)
            {
                ...
                java.awt.Color a6 = RadixTrieMultiDigitalElementArray.DEFAULT_BACKGROUND_COLOR;
    ...
    static
    {
        String s = localization.Messages.getString("RadixTrieMultiDigitalElementArray.0");
        RadixTrieMultiDigitalElementArray.BIT_ARRAY_LABEL = s;
        java.awt.Color a = java.awt.Color.black;
        RadixTrieMultiDigitalElementArray.DEFAULT_TEXT_COLOR = a;
        java.awt.Color a0 = java.awt.Color.white;
        RadixTrieMultiDigitalElementArray.DEFAULT_BACKGROUND_COLOR = a0;
    }
}