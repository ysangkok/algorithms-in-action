public class RadixTrieExternalNode extends RadixTrieNode {
    ...
    RadixTrieExternalNode(RadixTrieDataItem a)
    {
        super();
        java.awt.Color a0 = RadixTrieColors.DEFAULT_NODE_COLOR;
    ...
    public static void setCompareNode(RadixTrieExternalNode a)
    {
        RadixTrieExternalNode.compareNode = a;
    }
    ...
    public int getKey()
    {
        RadixTrieDataItem a = this.dataItem;
        int i = a.getKey();
        return i;
    }
    ...
    public void setPosition(java.awt.Point a)
    {
        ...
        RadixTrieExternalNode.upperLeft = a0;
        java.awt.Point a1 = RadixTrieExternalNode.upperLeft;
        int i = a.x;
        int i0 = i - 9;
        a1.x = i0;
        java.awt.Point a2 = RadixTrieExternalNode.upperLeft;
        int i1 = a.y;
        int i2 = i1 - 9;
        a2.y = i2;
        java.awt.Point a3 = new java.awt.Point();
        RadixTrieExternalNode.lowerRight = a3;
        java.awt.Point a4 = RadixTrieExternalNode.lowerRight;
        int i3 = a.x;
        int i4 = i3 + 9;
        a4.x = i4;
        java.awt.Point a5 = RadixTrieExternalNode.lowerRight;
        int i5 = a.y;
        int i6 = i5 + 9;
        a5.y = i6;
    ...
    protected synchronized java.awt.Point layout(int i, int i0)
    {
        ...
        int i7 = a4.y;
        int i8 = i7 - 9;
        java.awt.Point a5 = RadixTrieExternalNode.upperLeft;
        int i9 = a5.y;
        if(i8 < i9)
        {
            java.awt.Point a6 = RadixTrieExternalNode.upperLeft;
        ...
        int i12 = a8.x;
        int i13 = i12 + 9;
        java.awt.Point a9 = RadixTrieExternalNode.lowerRight;
        int i14 = a9.x;
        if(i13 > i14)
        {
            java.awt.Point a10 = RadixTrieExternalNode.lowerRight;
        ...
        int i17 = a12.y;
        int i18 = i17 + 9;
        java.awt.Point a13 = RadixTrieExternalNode.lowerRight;
        int i19 = a13.y;
        if(i18 > i19)
        {
            java.awt.Point a14 = RadixTrieExternalNode.lowerRight;
    ...
    public java.awt.Rectangle getRectangle()
    {
        java.awt.Point a = this.position;
        this.setPosition(a);
        java.awt.Point a0 = RadixTrieExternalNode.upperLeft;
        int i = a0.x;
        java.awt.Point a1 = RadixTrieExternalNode.upperLeft;
        int i0 = a1.y;
        java.awt.Point a2 = RadixTrieExternalNode.lowerRight;
        int i1 = a2.x;
        java.awt.Point a3 = RadixTrieExternalNode.upperLeft;
        int i2 = a3.x;
        int i3 = i1 - i2;
        java.awt.Point a4 = RadixTrieExternalNode.lowerRight;
        int i4 = a4.y;
    ...
    {
        RadixTrieInternalNode a0 = this.parent;
        if(a0 == null)
        {
            this.drawNode(a);
        }
    ...
    public void drawNode(java.awt.Graphics a)
    {
        ...
        RadixTrieDataItem a2 = this.dataItem;
        int i = a2.getKey();
        StringBuilder a3 = a1.append(i);
        String s = a3.toString();
        RadixTrieExternalNode a4 = RadixTrieExternalNode.newestNode;
        label1: {
            label0: {
                if(a4 != this)
                {
                ...
                java.awt.Color a5 = RadixTrieColors.NEW_NODE_COLOR;
                this.currentBackgroundColor = a5;
                break label1;
            }
            RadixTrieExternalNode a6 = RadixTrieExternalNode.compareNode;
            if(a6 != this)
            {
            ...
            {
                java.awt.Color a8 = RadixTrieColors.COMPARE_NODE_COLOR;
