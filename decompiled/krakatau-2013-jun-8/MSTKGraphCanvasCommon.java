public class MSTKGraphCanvasCommon {
    ...
    protected MSTKGraphMapsCanvas m_canvas;
    protected aia.graph.common.GraphMaps m_algorithm;
    
    MSTKGraphCanvasCommon(MSTKGraphMapsCanvas a, aia.graph.common.GraphMaps a0)
    {
        super();
        this.GRAPH_X = 30;
        this.GRAPH_Y = 30;
        ...
        label0: {
            ...
            while(true)
            {
                ...
                else
                {
                    ...
                    a4.setPosition(a5);
                    MSTKGraphMapsCanvas a6 = this.m_canvas;
    ...
    {
        MSTKGraphMapsCanvas a = this.m_canvas;
        a.setSize(440, 360);
        java.util.Vector a0 = this.vecNodes;
        label1: {
            int i = 0;
            ...
            while(true)
            {
                ...
                int i22 = i19;
                int i23 = i20;
                MSTKGraphMapsCanvas a5 = this.m_canvas;
                int i24 = i22;
                int i25 = i23;
                int i26 = i21 + 20;
                int i27 = i25;
                ...
                int i36 = i6;
                int i37 = i7;
                MSTKGraphMapsCanvas a7 = this.m_canvas;
                int i38 = i36;
                int i39 = i37;
                int i40 = i35 + 20;
                int i41 = i38;
                ...
                else
                {
                    ...
                    int i45 = a4.getY();
                    int i46 = i44;
                    MSTKGraphMapsCanvas a8 = this.m_canvas;
                    int i47 = i46;
                    int i48 = i45 + 20;
                    i8 = i47;
                    i9 = i48;
            ...
            MSTKGraphMapsCanvas a9 = this.m_canvas;
            a9.setSize(i50, i51);
        }
    }
    ...
    public void processDialogEvent(String s, String s0)
    {
        ...
        label0: {
            ...
            String s1 = localization.Messages.getString("MSTKGraphCanvasCommon.0");
            ...
            String s2 = localization.Messages.getString("MSTKGraphCanvasCommon.1");
        ...
        label2: {
            ...
            MSTKGraphMapsCanvas a11 = this.m_canvas;
            MSTKGraphMapsCanvas a12 = this.m_canvas;
    ...
    public void mouseMoved(int i, int i0)
    {
        ...
        label1: {
            ...
            MSTKGraphMapsCanvas a = this.m_canvas;
            int i2 = i - 10;
            MSTKGraphMapsCanvas a0 = this.m_canvas;
            int i3 = i0 - 10;
            aia.graph.common.GraphMaps a1 = this.m_algorithm;
            label2: {
                if(a1 == null)
        ...
        label4: {
            ...
            label6: {
                label5: {
                    ...
                    a12.setSize(100, 20);
                    MSTKGraphMapsCanvas a13 = this.m_canvas;
                    java.awt.Frame a14 = this.m_frmKeyChange;
                    String s = localization.Messages.getString("MSTKGraphCanvasCommon.2");
                    String s0 = localization.Messages.getString("MSTKGraphCanvasCommon.3");
                ...
                label9: {
                    ...
                    if(i27 != 0)
                    {
                        ...
                        a26.setSize(100, 20);
                        MSTKGraphMapsCanvas a27 = this.m_canvas;
                        java.awt.Frame a28 = this.m_frmEditLink;
                        String s1 = localization.Messages.getString("MSTKGraphCanvasCommon.4");
                        String s2 = localization.Messages.getString("MSTKGraphCanvasCommon.5");
    ...
    public void drawLinks(java.awt.Graphics a)
    {
        ...
        label2: {
            ...
            while(true)
            {
                ...
                int i9 = i7 + i8;
                int i10 = a7.getX();
                MSTKGraphMapsCanvas a10 = this.m_canvas;
                int i11 = i10 + 10;
            ...
            while(true)
            {
                ...
                else
                {
                    ...
                    int i27 = a19.getX();
                    MSTKGraphMapsCanvas a21 = this.m_canvas;
                    int i28 = i27 + 10;
                    int i29 = this.GRAPH_X;
                    int i30 = i28 + i29;
                    int i31 = a19.getY();
                    MSTKGraphMapsCanvas a22 = this.m_canvas;
                    int i32 = i31 + 10;
                    int i33 = this.GRAPH_Y;
                    int i34 = i32 + i33;
                    int i35 = a20.getX();
                    MSTKGraphMapsCanvas a23 = this.m_canvas;
                    int i36 = i35 + 10;
                    int i37 = this.GRAPH_X;
                    int i38 = i36 + i37;
                    int i39 = a20.getY();
                    MSTKGraphMapsCanvas a24 = this.m_canvas;
                    int i40 = i39 + 10;
                    int i41 = this.GRAPH_Y;
                    int i42 = i40 + i41;
                    com.cim.AIA.Line a25 = new com.cim.AIA.Line(i30, i34, i38, i42);
                    MSTKGraphMapsCanvas a26 = this.m_canvas;
