public class MergeSortAnimationWindow extends com.cim.AIA.AnimationWindow {
    ...
    public MergeSortAnimationWindow(com.cim.AIA.AlgorithmCanvas a, com.cim.AIA.AlgorithmThread a0, java.applet.Applet a1)
    {
        super(a, a0, a1);
        ...
        String s = MergeSortAnimationWindow.FRAME_TITLE;
        this.frameTitle = s;
        String s0 = MergeSortAnimationWindow.DEFAULT_LABEL;
        int[] a3 = MergeSortAnimationWindow.DEFAULT_DATA;
        ...
        String s1 = MergeSortAnimationWindow.SORTED_LABEL;
        int[] a5 = MergeSortAnimationWindow.SORTED_DATA;
        ...
        String s2 = MergeSortAnimationWindow.REVERSE_SORTED_LABEL;
        int[] a7 = MergeSortAnimationWindow.REVERSE_SORTED_DATA;
        ...
        String s3 = MergeSortAnimationWindow.SAME_LABEL;
        ...
        String s4 = MergeSortAnimationWindow.RANDOM_LABEL;
        ...
        String s5 = MergeSortAnimationWindow.USER_SELECTION_LABEL;
        StringBuilder a12 = a11.append(s5);
        StringBuilder a13 = a12.append("...");
        String s6 = a13.toString();
        String s7 = MergeSortAnimationWindow.USER_SELECTION_LABEL;
        int i7 = this.minSize;
        int i8 = this.maxSize;
    ...
    static
    {
        String s = localization.Messages.getString("MergeSortAnimationWindow.2");
        MergeSortAnimationWindow.FRAME_TITLE = s;
        int[] a = new int[15];
        a[0] = 75;
        a[1] = 5;
        a[2] = 70;
        ...
        a[13] = 35;
        a[14] = 40;
        MergeSortAnimationWindow.DEFAULT_DATA = a;
        int[] a0 = new int[15];
        a0[0] = 5;
        a0[1] = 10;
        a0[2] = 15;
        ...
        a0[13] = 70;
        a0[14] = 75;
        MergeSortAnimationWindow.SORTED_DATA = a0;
        int[] a1 = new int[15];
        a1[0] = 75;
        a1[1] = 70;
        a1[2] = 65;
        ...
        a1[13] = 10;
        a1[14] = 5;
        MergeSortAnimationWindow.REVERSE_SORTED_DATA = a1;
    }
}