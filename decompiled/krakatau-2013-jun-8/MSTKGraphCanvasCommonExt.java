public class MSTKGraphCanvasCommonExt extends aia.graph.common.GraphMapsCanvasExt {
    ...
    MSTKGraphCanvasCommonExt(MSTKGraphMapsCanvasExt a, MSTKGraphMaps a0)
    {
        super();
    ...
    public void setMatrix(java.util.Vector a, int i, int i0)
    {
        ...
        label0: {
            ...
            while(true)
            {
                ...
                MSTKGraphMaps a5 = this.m_algorithm;
                int i9 = a5.getMatrixShowing()?1:0;
                if(i9 != 0)
                {
                    MSTKGraphMapsCanvasExt a6 = this.m_canvas;
            ...
            int i11 = a7.size();
            MSTKGraphMapsCanvasExt a8 = this.m_canvas;
            int i12 = i11 * 20;
    ...
    private void calculateStructureHeight()
    {
        ...
        label1: {
            ...
            while(true)
            {
                ...
                int i9 = i8;
                MSTKGraphMapsCanvasExt a3 = this.m_canvas;
                int i10 = i9;
                int i11 = 20;
                int i12 = i10;
                ...
                while(true)
                {
                    ...
                    MSTKGraphMapsCanvasExt a5 = this.m_canvas;
                    int i17 = i13;
    ...
    public void processDialogEvent(String s, String s0)
    {
        ...
        label0: {
            ...
            String s1 = localization.Messages.getString("MSTKGraphCanvasCommonExt.0");
        ...
        MSTKGraphMaps a3 = this.m_algorithm;
        if(a3 != null)
        {
            MSTKGraphMapsCanvasExt a4 = this.m_canvas;
            MSTKGraphMapsCanvasExt a5 = this.m_canvas;
            MSTKGraphMaps a6 = this.m_algorithm;
    ...
    public void editMatrix(aia.graph.common.GraphMapsNode a)
    {
        ...
        label0: {
            ...
            if(i == 0)
            {
                ...
                String s = localization.Messages.getString("MSTKGraphCanvasCommonExt.1");
                String s0 = localization.Messages.getString("MSTKGraphCanvasCommonExt.2");
    ...
    public void drawAdjacencyMatrix(java.awt.Graphics a)
    {
        ...
        label1: {
            ...
            a.setColor(a3);
            String s = localization.Messages.getString("MSTKGraphCanvasCommonExt.3");
            int i0 = this.MATRIX_X;
            int i1 = this.MATRIX_Y;
            int i2 = a2.getHeight();
            int i3 = i1 - i2;
            a.drawString(s, i0, i3);
            String s0 = localization.Messages.getString("MSTKGraphCanvasCommonExt.4");
            int i4 = this.MATRIX_X;
            String s1 = localization.Messages.getString("MSTKGraphCanvasCommonExt.5");
            ...
            String s2 = localization.Messages.getString("MSTKGraphCanvasCommonExt.6");
            ...
            while(true)
            {
                ...
                else
                {
                    ...
                    int i19 = 20 * i16;
                    int i20 = i18 + i19;
                    MSTKGraphMapsCanvasExt a9 = this.m_canvas;
                    ...
                    MSTKGraphMapsCanvasExt a10 = this.m_canvas;
                    int i32 = i16 + 1;
                    int i33 = 20 * i32;
                    int i34 = i31 + i33;
                    ...
                    a13.draw(a);
                    MSTKGraphMapsCanvasExt a14 = this.m_canvas;
    ...
    public void drawAdjacencyStructure(java.awt.Graphics a)
    {
        ...
        label1: {
            ...
            String s = localization.Messages.getString("MSTKGraphCanvasCommonExt.7");
            ...
            while(true)
            {
                ...
                while(true)
                {
                    label3: {
                        ...
                        int i8 = a12.getX();
                        MSTKGraphMapsCanvasExt a16 = this.m_canvas;
                        int i9 = i8 + 10;
                        int i10 = a12.getY();
                        MSTKGraphMapsCanvasExt a17 = this.m_canvas;
                        int i11 = this.LINK_LENGTH;
                        int i12 = 20 + i11;
                        int i13 = i7 - 1;
                        int i14 = i12 * i13;
                        int i15 = i10 + i14;
                        MSTKGraphMapsCanvasExt a18 = this.m_canvas;
                        int i16 = i15 + 20;
                        int i17 = a12.getX();
                        MSTKGraphMapsCanvasExt a19 = this.m_canvas;
                        int i18 = i17 + 10;
                        int i19 = a12.getY();
                        MSTKGraphMapsCanvasExt a20 = this.m_canvas;
                        ...
                        int i26 = a12.getX();
                        int i27 = a12.getY();
                        MSTKGraphMapsCanvasExt a24 = this.m_canvas;
                        ...
                        a23.setPosition(a25);
                        MSTKGraphMapsCanvasExt a26 = this.m_canvas;
                        a26.setStructureNodeAppearance(a23, a12);
                        MSTKGraphMapsCanvasExt a27 = this.m_canvas;
