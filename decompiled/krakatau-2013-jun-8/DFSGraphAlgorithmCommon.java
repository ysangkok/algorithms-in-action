public class DFSGraphAlgorithmCommon {
    ...
    DFSGraphAlgorithmCommon(aia.graph.common.GraphMaps a, Object a0)
    {
        super();
    ...
    public void startEditLink(Integer a)
    {
        ...
        label1: {
            ...
            this.m_startNode = -10;
            this.m_endNode = -10;
            com.cim.common.MessageDialog a1 = DFSGraphAlgorithmCommon.messageDialog;
            if(a1 != null)
            {
                com.cim.common.MessageDialog a2 = DFSGraphAlgorithmCommon.messageDialog;
                a2.dispose();
            }
            String s = localization.Messages.getString("DFSGraphAlgorithmCommon.3");
            com.cim.common.MessageDialog a3 = new com.cim.common.MessageDialog(s, false, false);
            DFSGraphAlgorithmCommon.messageDialog = a3;
            com.cim.common.MessageDialog a4 = DFSGraphAlgorithmCommon.messageDialog;
            String s0 = localization.Messages.getString("DFSGraphAlgorithmCommon.4");
            a4.setTitle(s0);
            com.cim.common.MessageDialog a5 = DFSGraphAlgorithmCommon.messageDialog;
            a5.setVisible(true);
    ...
    {
        this.m_startNode = i;
        com.cim.common.MessageDialog a = DFSGraphAlgorithmCommon.messageDialog;
        if(a != null)
        {
            com.cim.common.MessageDialog a0 = DFSGraphAlgorithmCommon.messageDialog;
            a0.dispose();
        }
        String s = localization.Messages.getString("DFSGraphAlgorithmCommon.5");
        com.cim.common.MessageDialog a1 = new com.cim.common.MessageDialog(s, false, false);
        DFSGraphAlgorithmCommon.messageDialog = a1;
        com.cim.common.MessageDialog a2 = DFSGraphAlgorithmCommon.messageDialog;
        String s0 = localization.Messages.getString("DFSGraphAlgorithmCommon.6");
        a2.setTitle(s0);
        com.cim.common.MessageDialog a3 = DFSGraphAlgorithmCommon.messageDialog;
        a3.setVisible(true);
    ...
    public void setKeyChangeMode(boolean b)
    {
        ...
        label1: {
            ...
            if(i1 != 0)
            {
                String s = localization.Messages.getString("DFSGraphAlgorithmCommon.7");
                com.cim.common.MessageDialog a2 = new com.cim.common.MessageDialog(s, false, false);
                DFSGraphAlgorithmCommon.messageDialog = a2;
                com.cim.common.MessageDialog a3 = DFSGraphAlgorithmCommon.messageDialog;
                String s0 = localization.Messages.getString("DFSGraphAlgorithmCommon.8");
                a3.setTitle(s0);
                com.cim.common.MessageDialog a4 = DFSGraphAlgorithmCommon.messageDialog;
                a4.setVisible(true);
            }
    ...
    public void setInsertionMode(boolean b)
    {
        ...
        label1: {
            ...
            if(i1 != 0)
            {
                String s = localization.Messages.getString("DFSGraphAlgorithmCommon.9");
                com.cim.common.MessageDialog a2 = new com.cim.common.MessageDialog(s, false, false);
                DFSGraphAlgorithmCommon.messageDialog = a2;
                com.cim.common.MessageDialog a3 = DFSGraphAlgorithmCommon.messageDialog;
                String s0 = localization.Messages.getString("DFSGraphAlgorithmCommon.10");
                a3.setTitle(s0);
                com.cim.common.MessageDialog a4 = DFSGraphAlgorithmCommon.messageDialog;
                a4.setVisible(true);
            }
    ...
    public void setDeleteMode(boolean b)
    {
        ...
        label1: {
            ...
            if(i1 != 0)
            {
                String s = localization.Messages.getString("DFSGraphAlgorithmCommon.11");
                com.cim.common.MessageDialog a2 = new com.cim.common.MessageDialog(s, false, false);
                DFSGraphAlgorithmCommon.messageDialog = a2;
                com.cim.common.MessageDialog a3 = DFSGraphAlgorithmCommon.messageDialog;
                String s0 = localization.Messages.getString("DFSGraphAlgorithmCommon.12");
                a3.setTitle(s0);
                com.cim.common.MessageDialog a4 = DFSGraphAlgorithmCommon.messageDialog;
                a4.setVisible(true);
            }
