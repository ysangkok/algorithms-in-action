public class SplayTreeIterApplet extends com.cim.AIA.AlgorithmApplet {
    ...
    public SplayTreeIterApplet()
    {
        ...
        String s = SplayTreeIterApplet.ALGORITHM_FILE_NAME;
        this.algorithmFileName = s;
        String s0 = SplayTreeIterApplet.EXPLANATION_TITLE;
        this.explanationTitle = s0;
        String s1 = SplayTreeIterApplet.EXPLANATION_FILE_NAME;
        this.explanationFileName = s1;
    }
    
    public com.cim.AIA.Copyable getInitialData()
    {
        int[] a = SplayTreeIterAnimationWindow.DEFAULT_DATA;
    ...
    {
        Object a1 = a;
        SplayTreeIterThread a2 = new SplayTreeIterThread((com.cim.AIA.Copyable)a1, a0);
        return a2;
    }
    
    public com.cim.AIA.AlgorithmCanvas getAlgorithmCanvas()
    {
        SplayTreeIterCanvas a = new SplayTreeIterCanvas();
        return a;
    }
    ...
    {
        SplayTreeIterAnimationWindow a2 = new SplayTreeIterAnimationWindow(a, a0, a1);
        return a2;
    }
    ...
    protected void otherInitialisation()
    {
        ...
        SplayTreeIter dummy = (SplayTreeIter)a;
        SplayTreeIter a0 = (SplayTreeIter)a;
    ...
    static
    {
        String s = localization.Messages.getString("SplayTreeIterApplet.1");
        SplayTreeIterApplet.ALGORITHM_FILE_NAME = s;
        String s0 = localization.Messages.getString("SplayTreeIterApplet.2");
        SplayTreeIterApplet.EXPLANATION_TITLE = s0;
        String s1 = localization.Messages.getString("SplayTreeIterApplet.3");
        SplayTreeIterApplet.EXPLANATION_FILE_NAME = s1;
    }
}