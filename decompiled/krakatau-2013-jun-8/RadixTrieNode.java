abstract public class RadixTrieNode implements com.cim.AIA.Drawable {
    final static int NODE_Y_GAP = 20;
    ...
    protected RadixTrieInternalNode parent;
    ...
    abstract public RadixTrieInternalNode getParent();
