public class SkipListApplet extends com.cim.AIA.AlgorithmApplet {
    ...
    public SkipListApplet()
    {
        ...
        String s = SkipListApplet.ALGORITHM_FILE_NAME;
        this.algorithmFileName = s;
        String s0 = SkipListApplet.EXPLANATION_TITLE;
        this.explanationTitle = s0;
        String s1 = SkipListApplet.EXPLANATION_FILE_NAME;
        this.explanationFileName = s1;
        com.cim.AIA.AlgorithmWindow a = this.window;
        SkipListApplet.lastWindow = a;
    }
    
    public com.cim.AIA.Copyable getInitialData()
    {
        int[] a = SkipListAnimationWindow.DEFAULT_DATA;
    ...
    protected void otherInitialisation()
    {
        ...
        SkipList dummy = (SkipList)a;
        SkipList a0 = (SkipList)a;
    ...
    public com.cim.AIA.AlgorithmThread getAlgorithmThread(com.cim.AIA.Copyable a, com.cim.AIA.AlgorithmWindow a0)
    {
        ...
        SkipListThread a3 = new SkipListThread((com.cim.AIA.Copyable)a1, (com.cim.AIA.AlgorithmWindow)a2);
        return a3;
    }
    
    public com.cim.AIA.AlgorithmCanvas getAlgorithmCanvas()
    {
        SkipListCanvas a = new SkipListCanvas();
        return a;
    }
    
    public com.cim.AIA.AlgorithmWindow getAlgorithmWindow()
    {
        com.cim.AIA.AlgorithmWindow a = SkipListApplet.lastWindow;
        return a;
    }
    ...
    {
        SkipListAnimationWindow a2 = new SkipListAnimationWindow(a, a0, a1);
        return a2;
    }
    ...
    static
    {
        String s = localization.Messages.getString("SkipListApplet.1");
        SkipListApplet.ALGORITHM_FILE_NAME = s;
        String s0 = localization.Messages.getString("SkipListApplet.2");
        SkipListApplet.EXPLANATION_TITLE = s0;
        String s1 = localization.Messages.getString("SkipListApplet.3");
        SkipListApplet.EXPLANATION_FILE_NAME = s1;
