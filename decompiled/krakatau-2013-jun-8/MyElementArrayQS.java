public class MyElementArrayQS implements com.cim.AIA.Drawable, com.cim.AIA.Selectable, com.cim.AIA.ObjectContainer {
    ...
    public MyElementArrayQS(int i, int i0)
    {
        super();
        this.columGap = 10;
    ...
    public boolean equals(com.cim.AIA.Selectable a)
    {
        ...
        label1: {
            Object a0 = null;
            label0: {
                int i0 = a instanceof MyElementArrayQS?1:0;
                a0 = a;
                if(i0 != 0)
                {
                    break label0;
            ...
            MyElementArrayQS a1 = (MyElementArrayQS)a0;
