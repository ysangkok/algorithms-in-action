public class InsertionSortAnimationWindow extends com.cim.AIA.AnimationWindow {
    final private static long serialVersionUID = -3340826692997154455L;
    final protected static String BUILD_DATE = "dd/mm/yy";
    final protected static String BUILD_BY = "Initial.Surname";
    ...
    public InsertionSortAnimationWindow(com.cim.AIA.AlgorithmCanvas a, com.cim.AIA.AlgorithmThread a0, java.applet.Applet a1)
    {
        super(a, a0, a1);
        ...
        String s = InsertionSortAnimationWindow.FRAME_TITLE;
        this.frameTitle = s;
        String s0 = InsertionSortAnimationWindow.DEFAULT_LABEL;
        int[] a2 = InsertionSortAnimationWindow.DEFAULT_DATA;
        ...
        String s1 = InsertionSortAnimationWindow.SORTED_LABEL;
        int[] a4 = InsertionSortAnimationWindow.SORTED_DATA;
        ...
        String s2 = InsertionSortAnimationWindow.REVERSE_SORTED_LABEL;
        int[] a6 = InsertionSortAnimationWindow.REVERSE_SORTED_DATA;
        ...
        String s3 = InsertionSortAnimationWindow.SAME_LABEL;
        ...
        String s4 = InsertionSortAnimationWindow.RANDOM_LABEL;
        ...
        String s5 = InsertionSortAnimationWindow.USER_SELECTION_LABEL;
        StringBuilder a11 = a10.append(s5);
        StringBuilder a12 = a11.append("...");
        String s6 = a12.toString();
        String s7 = InsertionSortAnimationWindow.USER_SELECTION_LABEL;
        int i7 = this.minSize;
        int i8 = this.maxSize;
    ...
    static
    {
        String s = localization.Messages.getString("InsertionSortAnimationWindow.2");
        InsertionSortAnimationWindow.FRAME_TITLE = s;
        int[] a = new int[15];
        a[0] = 75;
        a[1] = 5;
        a[2] = 70;
        ...
        a[13] = 35;
        a[14] = 40;
        InsertionSortAnimationWindow.DEFAULT_DATA = a;
        int[] a0 = new int[15];
        a0[0] = 5;
        a0[1] = 10;
        a0[2] = 15;
        ...
        a0[13] = 70;
        a0[14] = 75;
        InsertionSortAnimationWindow.SORTED_DATA = a0;
        int[] a1 = new int[15];
        a1[0] = 75;
        a1[1] = 70;
        a1[2] = 65;
        ...
        a1[13] = 10;
        a1[14] = 5;
        InsertionSortAnimationWindow.REVERSE_SORTED_DATA = a1;
    }
}