public class PatriciaTreeDataItem {
    ...
    PatriciaTreeDataItem()
    {
        ...
        java.awt.Color a1 = PatriciaTreeColors.DATA_ITEM_COLOR;
        a0.setBackgroundColor(a1);
        com.cim.AIA.Node a2 = this.node;
        java.awt.Color a3 = PatriciaTreeColors.DATA_ITEM_HIGHLIGHT_COLOR;
        a2.setHighlightColor(a3);
    }
    
    PatriciaTreeDataItem(com.cim.AIA.Node a, int i)
    {
        super();
        this.node = a;
        this.key = i;
        ...
        com.cim.AIA.Node a2 = this.node;
        java.awt.Color a3 = PatriciaTreeColors.DATA_ITEM_COLOR;
        a2.setBackgroundColor(a3);
        com.cim.AIA.Node a4 = this.node;
        java.awt.Color a5 = PatriciaTreeColors.DATA_ITEM_HIGHLIGHT_COLOR;
