public class SplayTreeIterDataItem extends com.cim.AIA.Element {
    private int key;
    ...
    public SplayTreeIterDataItem(String s, int i)
    {
        super(2, (Object)s);
    ...
    public boolean equals(com.cim.AIA.Selectable a)
    {
        ...
        label1: {
            Object a0 = null;
            label0: {
                int i0 = a instanceof SplayTreeIterDataItem?1:0;
                a0 = a;
                if(i0 != 0)
                {
                    break label0;
            ...
            String s = this.label;
            SplayTreeIterDataItem dummy = (SplayTreeIterDataItem)a0;
            SplayTreeIterDataItem a1 = (SplayTreeIterDataItem)a0;
            String s0 = a1.label;
    ...
    public com.cim.AIA.Selectable getItemAt(java.awt.Point a)
    {
        ...
        SplayTreeIterDataItem a3 = i3 == 0?null:this;
