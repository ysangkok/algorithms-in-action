public class BFSGraphMapsAnimationWindowExt extends com.cim.AIA.AnimationWindow {
    final private static long serialVersionUID = -9039246186300035755L;
    ...
    public BFSGraphMapsAnimationWindowExt(com.cim.AIA.AlgorithmCanvas a, com.cim.AIA.AlgorithmThread a0, java.applet.Applet a1)
    {
        super(a, a0, a1);
        ...
        String s = localization.Messages.getString("GraphMapsAnimationWindowExt.1");
        this.HIDE_MATRIX_LABEL = s;
        String s0 = localization.Messages.getString("GraphMapsAnimationWindowExt.2");
        this.SHOW_MATRIX_LABEL = s0;
        String s1 = localization.Messages.getString("GraphMapsAnimationWindowExt.3");
        this.HIDE_STRUCTURE_LABEL = s1;
        String s2 = localization.Messages.getString("GraphMapsAnimationWindowExt.4");
        this.SHOW_STRUCTURE_LABEL = s2;
        String s3 = BFSGraphMapsAnimationWindowExt.FRAME_TITLE;
        this.frameTitle = s3;
        ...
        BFSGraphMapsAnimationWindowExt$1 a8 = new BFSGraphMapsAnimationWindowExt$1(this);
        this.addControlListener((com.cim.AIA.ControlListener)a8);
        BFSGraphMapsThread dummy = (BFSGraphMapsThread)a0;
        BFSGraphMapsThread a9 = (BFSGraphMapsThread)a0;
        this.graphMapsThread = a9;
    }
    ...
    static
    {
        String s = localization.Messages.getString("GraphMapsAnimationWindowExt.0");
        BFSGraphMapsAnimationWindowExt.FRAME_TITLE = s;
    }
}