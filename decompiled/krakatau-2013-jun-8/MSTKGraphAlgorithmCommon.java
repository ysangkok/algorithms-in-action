public class MSTKGraphAlgorithmCommon extends aia.graph.common.GraphAlgorithmCommon {
    ...
    MSTKGraphAlgorithmCommon(MSTKGraphMaps a, Object a0)
    {
        super();
    ...
    {
        MSTKGraphMaps a0 = this.m_algorithm;
        ...
        label1: {
            ...
            this.m_startNode = -10;
            this.m_endNode = -10;
            com.cim.common.MessageDialog a1 = MSTKGraphAlgorithmCommon.messageDialog;
            if(a1 != null)
            {
                com.cim.common.MessageDialog a2 = MSTKGraphAlgorithmCommon.messageDialog;
                a2.dispose();
            }
            String s = localization.Messages.getString("MSTKGraphAlgorithmCommon.3");
            com.cim.common.MessageDialog a3 = new com.cim.common.MessageDialog(s, false, false);
            MSTKGraphAlgorithmCommon.messageDialog = a3;
            com.cim.common.MessageDialog a4 = MSTKGraphAlgorithmCommon.messageDialog;
            String s0 = localization.Messages.getString("MSTKGraphAlgorithmCommon.4");
            a4.setTitle(s0);
            com.cim.common.MessageDialog a5 = MSTKGraphAlgorithmCommon.messageDialog;
            a5.setVisible(true);
    ...
    {
        this.m_startNode = i;
        com.cim.common.MessageDialog a = MSTKGraphAlgorithmCommon.messageDialog;
        if(a != null)
        {
            com.cim.common.MessageDialog a0 = MSTKGraphAlgorithmCommon.messageDialog;
            a0.dispose();
        }
        String s = localization.Messages.getString("MSTKGraphAlgorithmCommon.5");
        com.cim.common.MessageDialog a1 = new com.cim.common.MessageDialog(s, false, false);
        MSTKGraphAlgorithmCommon.messageDialog = a1;
        com.cim.common.MessageDialog a2 = MSTKGraphAlgorithmCommon.messageDialog;
        String s0 = localization.Messages.getString("MSTKGraphAlgorithmCommon.6");
        a2.setTitle(s0);
        com.cim.common.MessageDialog a3 = MSTKGraphAlgorithmCommon.messageDialog;
        a3.setVisible(true);
        int i0 = this.m_editLinkStep;
        int i1 = i0 + 1;
        this.m_editLinkStep = i1;
        MSTKGraphMaps a4 = this.m_algorithm;
        a4.repaint();
    }
    ...
    public void endEditLink()
    {
        ...
        MSTKGraphAlgorithmCommon.messageDialog = null;
        MSTKGraphMaps a1 = this.m_algorithm;
        a1.repaint();
    }
    ...
    public void setStructureShowing(boolean b)
    {
        ...
        MSTKGraphMaps a = this.m_algorithm;
        a.repaint();
    }
    ...
    public void setNodePosition(int i, int i0, int i1)
    {
        ...
        if(a != null)
        {
            ...
            int i19 = i18 + 2;
            a1[i19] = i13;
            MSTKGraphMaps a2 = this.m_algorithm;
            a2.repaint();
        }
    }
    ...
    public void setKeyChangeMode(boolean b)
    {
        ...
        label1: {
            ...
            if(i1 != 0)
            {
                String s = localization.Messages.getString("MSTKGraphAlgorithmCommon.7");
                com.cim.common.MessageDialog a2 = new com.cim.common.MessageDialog(s, false, false);
                MSTKGraphAlgorithmCommon.messageDialog = a2;
                com.cim.common.MessageDialog a3 = MSTKGraphAlgorithmCommon.messageDialog;
                String s0 = localization.Messages.getString("MSTKGraphAlgorithmCommon.8");
                a3.setTitle(s0);
                com.cim.common.MessageDialog a4 = MSTKGraphAlgorithmCommon.messageDialog;
                a4.setVisible(true);
            }
    ...
    public void keyChange(int i, int i0)
    {
        ...
        label2: {
            ...
            MSTKGraphMaps a17 = this.m_algorithm;
            a17.repaint();
        }
    }
    ...
    public void setInsertionMode(boolean b)
    {
        ...
        label1: {
            ...
            if(i1 != 0)
            {
                String s = localization.Messages.getString("MSTKGraphAlgorithmCommon.9");
                com.cim.common.MessageDialog a2 = new com.cim.common.MessageDialog(s, false, false);
                MSTKGraphAlgorithmCommon.messageDialog = a2;
                com.cim.common.MessageDialog a3 = MSTKGraphAlgorithmCommon.messageDialog;
                String s0 = localization.Messages.getString("MSTKGraphAlgorithmCommon.10");
                a3.setTitle(s0);
                com.cim.common.MessageDialog a4 = MSTKGraphAlgorithmCommon.messageDialog;
                a4.setVisible(true);
            }
    ...
    public void insertNewNode(int i, int i0)
    {
        ...
        while(true)
        {
            ...
            if(i51 >= i52)
            {
                ...
                MSTKGraphMaps a13 = this.m_algorithm;
                a13.repaint();
                return;
            }
            else
    ...
    public void setDeleteMode(boolean b)
    {
        ...
        label1: {
            ...
            if(i1 != 0)
            {
                String s = localization.Messages.getString("MSTKGraphAlgorithmCommon.11");
                com.cim.common.MessageDialog a2 = new com.cim.common.MessageDialog(s, false, false);
                MSTKGraphAlgorithmCommon.messageDialog = a2;
                com.cim.common.MessageDialog a3 = MSTKGraphAlgorithmCommon.messageDialog;
                String s0 = localization.Messages.getString("MSTKGraphAlgorithmCommon.12");
                a3.setTitle(s0);
                com.cim.common.MessageDialog a4 = MSTKGraphAlgorithmCommon.messageDialog;
                a4.setVisible(true);
            }
    ...
    public void deleteNode(int i)
    {
        ...
        label1: {
            ...
            MSTKGraphMaps a35 = this.m_algorithm;
            a35.repaint();
        }
    }
    ...
    public void editLink(aia.graph.common.GraphMapsNode a, int i)
    {
        ...
        MSTKGraphMaps a44 = this.m_algorithm;
        a44.repaint();
    }
    ...
    public java.util.Vector getNodes()
    {
        ...
        label1: {
            ...
            while(true)
            {
                ...
                MSTKGraphMaps a9 = this.m_algorithm;
                ...
                label3: {
                    ...
                    MSTKGraphMaps a10 = this.m_algorithm;
            ...
            while(true)
            {
                ...
                while(true)
                {
                    ...
                    else
                    {
                        ...
                        MSTKGraphMaps a14 = this.m_algorithm;
                        a14.setLinkAppearance(a13);
                        MSTKGraphMaps a15 = this.m_algorithm;
            ...
            while(true)
            {
                ...
                while(true)
                {
                    ...
                    else
                    {
                        ...
                        a6.setFrom(i);
                        a6.setTo(i1);
                        MSTKGraphMaps a7 = this.m_algorithm;
