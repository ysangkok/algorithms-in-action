public class MinSpanTreePrimGraphCanvasCommonExt extends aia.graph.common.GraphCanvasCommonExt {
    ...
    MinSpanTreePrimGraphCanvasCommonExt(aia.graph.common.GraphMapsCanvasExt a, aia.graph.common.GraphMaps a0)
    {
        super();
    ...
    public void setMatrix(java.util.Vector a, int i, int i0)
    {
        ...
        label0: {
            ...
            int i11 = a7.size();
            aia.graph.common.GraphMapsCanvasExt a8 = this.m_canvas;
            int i12 = i11 * 20;
    ...
    public void processDialogEvent(String s, String s0)
    {
        ...
        label0: {
            ...
            String s1 = localization.Messages.getString("MinSpanTreePrimGraphCanvasCommonExt.0");
    ...
    public void editMatrix(aia.graph.common.GraphMapsNode a)
    {
        ...
        label0: {
            ...
            if(i == 0)
            {
                ...
                String s = localization.Messages.getString("MinSpanTreePrimGraphCanvasCommonExt.7");
                String s0 = localization.Messages.getString("MinSpanTreePrimGraphCanvasCommonExt.8");
    ...
    public void drawAdjacencyMatrix(java.awt.Graphics a)
    {
        ...
        label1: {
            ...
            a.setColor(a3);
            String s = localization.Messages.getString("MinSpanTreePrimGraphCanvasCommonExt.9");
            int i0 = this.MATRIX_X;
            int i1 = this.MATRIX_Y;
            int i2 = a2.getHeight();
            int i3 = i1 - i2;
            a.drawString(s, i0, i3);
            String s0 = localization.Messages.getString("MinSpanTreePrimGraphCanvasCommonExt.10");
            int i4 = this.MATRIX_X;
            String s1 = localization.Messages.getString("MinSpanTreePrimGraphCanvasCommonExt.11");
            ...
            String s2 = localization.Messages.getString("MinSpanTreePrimGraphCanvasCommonExt.12");
            ...
            while(true)
            {
                ...
                else
                {
                    ...
                    int i19 = 20 * i16;
                    int i20 = i18 + i19;
                    aia.graph.common.GraphMapsCanvasExt a9 = this.m_canvas;
                    ...
                    a13.draw(a);
                    aia.graph.common.GraphMapsCanvasExt a14 = this.m_canvas;
    ...
    public void drawAdjacencyStructure(java.awt.Graphics a)
    {
        ...
        label1: {
            ...
            String s = localization.Messages.getString("MinSpanTreePrimGraphCanvasCommonExt.13");
            ...
            while(true)
            {
                ...
                while(true)
                {
                    label3: {
                        ...
                        int i8 = a12.getX();
                        aia.graph.common.GraphMapsCanvasExt a16 = this.m_canvas;
                        int i9 = i8 + 10;
                        int i10 = a12.getY();
                        aia.graph.common.GraphMapsCanvasExt a17 = this.m_canvas;
                        int i11 = this.LINK_LENGTH;
                        int i12 = 20 + i11;
                        int i13 = i7 - 1;
                        int i14 = i12 * i13;
                        int i15 = i10 + i14;
                        aia.graph.common.GraphMapsCanvasExt a18 = this.m_canvas;
                        int i16 = i15 + 20;
                        int i17 = a12.getX();
                        aia.graph.common.GraphMapsCanvasExt a19 = this.m_canvas;
                        int i18 = i17 + 10;
                        int i19 = a12.getY();
                        ...
                        int i26 = a12.getX();
                        int i27 = a12.getY();
                        aia.graph.common.GraphMapsCanvasExt a24 = this.m_canvas;
                        ...
                        a23.setPosition(a25);
                        aia.graph.common.GraphMapsCanvasExt a26 = this.m_canvas;
                        a26.setStructureNodeAppearance(a23, a12);
                        aia.graph.common.GraphMapsCanvasExt a27 = this.m_canvas;
