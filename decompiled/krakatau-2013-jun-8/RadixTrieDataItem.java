public class RadixTrieDataItem extends com.cim.AIA.Element {
    private int key;
    ...
    public RadixTrieDataItem(String s, int i)
    {
        super(2, (Object)s);
    ...
    public boolean equals(com.cim.AIA.Selectable a)
    {
        ...
        label1: {
            Object a0 = null;
            label0: {
                int i0 = a instanceof RadixTrieDataItem?1:0;
                a0 = a;
                if(i0 != 0)
                {
                    break label0;
            ...
            String s = this.label;
            RadixTrieDataItem dummy = (RadixTrieDataItem)a0;
            RadixTrieDataItem a1 = (RadixTrieDataItem)a0;
            String s0 = a1.label;
    ...
    public com.cim.AIA.Selectable getItemAt(java.awt.Point a)
    {
        ...
        RadixTrieDataItem a3 = i3 == 0?null:this;
