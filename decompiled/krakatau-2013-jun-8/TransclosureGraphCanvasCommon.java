public class TransclosureGraphCanvasCommon extends aia.graph.common.GraphCanvasCommon {
    ...
    TransclosureGraphCanvasCommon(aia.graph.common.GraphMapsCanvas a, aia.graph.common.GraphMaps a0)
    {
        super();
        this.GRAPH_X = 30;
        this.GRAPH_Y = 30;
    ...
    public void processDialogEvent(String s, String s0)
    {
        ...
        label0: {
            ...
            String s1 = localization.Messages.getString("TransclosureGraphCanvasCommon.0");
            ...
            String s2 = localization.Messages.getString("TransclosureGraphCanvasCommon.1");
        ...
        label4: {
            ...
            label6: {
                label5: {
                    ...
                    String s = localization.Messages.getString("TransclosureGraphCanvasCommon.2");
                    String s0 = localization.Messages.getString("TransclosureGraphCanvasCommon.3");
                ...
                label9: {
                    ...
                    if(i27 != 0)
                    {
                        ...
                        String s1 = localization.Messages.getString("TransclosureGraphCanvasCommon.4");
                        String s2 = localization.Messages.getString("TransclosureGraphCanvasCommon.5");
    ...
    public void drawLinks(java.awt.Graphics a)
    {
        ...
        label2: {
            ...
            while(true)
            {
                ...
                int i9 = i7 + i8;
                int i10 = a7.getX();
                aia.graph.common.GraphMapsCanvas a10 = this.m_canvas;
                int i11 = i10 + 10;
            ...
            while(true)
            {
                ...
                else
                {
                    ...
                    int i27 = a19.getX();
                    aia.graph.common.GraphMapsCanvas a21 = this.m_canvas;
                    int i28 = i27 + 10;
                    int i29 = this.GRAPH_X;
                    int i30 = i28 + i29;
                    int i31 = a19.getY();
                    aia.graph.common.GraphMapsCanvas a22 = this.m_canvas;
                    int i32 = i31 + 10;
                    int i33 = this.GRAPH_Y;
                    int i34 = i32 + i33;
                    int i35 = a20.getX();
                    aia.graph.common.GraphMapsCanvas a23 = this.m_canvas;
                    int i36 = i35 + 10;
                    int i37 = this.GRAPH_X;
                    int i38 = i36 + i37;
                    int i39 = a20.getY();
                    aia.graph.common.GraphMapsCanvas a24 = this.m_canvas;
                    int i40 = i39 + 10;
                    int i41 = this.GRAPH_Y;
                    int i42 = i40 + i41;
                    com.cim.AIA.Line a25 = new com.cim.AIA.Line(i30, i34, i38, i42);
                    aia.graph.common.GraphMapsCanvas a26 = this.m_canvas;
