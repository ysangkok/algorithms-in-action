public class SplayTreeAnimationWindow extends com.cim.AIA.AnimationWindow implements java.awt.event.ItemListener {
    ...
    public SplayTreeAnimationWindow(com.cim.AIA.AlgorithmCanvas a, com.cim.AIA.AlgorithmThread a0, java.applet.Applet a1)
    {
        super(a, a0, a1);
        this.buildDate = "Build Date";
        this.buildBy = "Your Initial.Your Surname";
        String s = SplayTreeAnimationWindow.FRAME_TITLE;
        this.frameTitle = s;
        ...
        String s10 = localization.Messages.getString("SplayTreeAnimationWindow.4");
        String s11 = localization.Messages.getString("SplayTreeAnimationWindow.5");
        ...
        String s12 = localization.Messages.getString("SplayTreeAnimationWindow.6");
        ...
        String s13 = SplayTreeAnimationWindow.DEFAULT_LABEL;
        int[] a11 = SplayTreeAnimationWindow.DEFAULT_DATA;
        ...
        String s14 = SplayTreeAnimationWindow.SORTED_LABEL;
        int[] a13 = SplayTreeAnimationWindow.SORTED_DATA;
        ...
        String s15 = SplayTreeAnimationWindow.RANDOM_LABEL;
        ...
        String s16 = SplayTreeAnimationWindow.USER_SELECTION_LABEL;
        StringBuilder a17 = a16.append(s16);
        StringBuilder a18 = a17.append("...");
        String s17 = a18.toString();
        String s18 = SplayTreeAnimationWindow.USER_SELECTION_LABEL;
        ...
        SplayTreeThread a20 = (SplayTreeThread)a0;
    ...
    public void itemStateChanged(java.awt.event.ItemEvent a)
    {
        ...
        label1: {
            label0: {
                ...
                SplayTreeCanvas dummy = (SplayTreeCanvas)a0;
                SplayTreeCanvas a1 = (SplayTreeCanvas)a0;
            ...
            if(i0 == 2)
            {
                ...
                SplayTreeCanvas dummy0 = (SplayTreeCanvas)a2;
                SplayTreeCanvas a3 = (SplayTreeCanvas)a2;
    ...
    static
    {
        String s = localization.Messages.getString("SplayTreeAnimationWindow.2");
        SplayTreeAnimationWindow.FRAME_TITLE = s;
        int[] a = new int[9];
        a[0] = 4;
        a[1] = 7;
        a[2] = 15;
        ...
        a[7] = 2;
        a[8] = 3;
        SplayTreeAnimationWindow.DEFAULT_DATA = a;
        int[] a0 = new int[29];
        a0[0] = 4;
        a0[1] = 7;
        a0[2] = 8;
        ...
        a0[27] = 19;
        a0[28] = 3;
        SplayTreeAnimationWindow.SORTED_DATA = a0;
        String s0 = localization.Messages.getString("SplayTreeAnimationWindow.3");
        SplayTreeAnimationWindow.SORTED_LABAL = s0;
    }
}